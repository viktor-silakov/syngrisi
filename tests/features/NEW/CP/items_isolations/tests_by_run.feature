Feature: Test Isolation by Run
    ...
    Scenario: Checks Isolation by Run - Two run
    ...
    Scenario: Runs - remove
        ...
        When I wait on element "[data-item-name='Run-1']" to be displayed
        When I click on the element "[data-item-name='Run-1']  [data-item='remove-popover-action-icon']"
        ...
        When I wait on element "[data-test='remove-item-modal-button']" to not be displayed


        When I open the app
        When I wait for "5" seconds
        When I wait on element "[data-item-name='Run-1']" to not be displayed
        When I wait on element "//div[contains(text(), 'TestRun-1')]" to not be displayed
