...
Feature: VRS Runs Smoke
    ...
    Scenario: VRS Runs - create single TEST
        ...
        Then I expect that element "//a[.='RUN-01']/../../div[@name='item-count']//span[@name='failedItems']" to have text "0"
        Then I expect that element "//a[.='RUN-01']/../../div[@name='item-count']//span[@name='totalItems']" to have text "1"
    ...
    Scenario: VRS Runs - create two TEST, same Run name
        ...
        Then I expect that element "//a[.='RUN-02']/../../div[@name='item-count']//span[@name='failedItems']" to have text "0"
        Then I expect that element "//a[.='RUN-02']/../../div[@name='item-count']//span[@name='totalItems']" to have text "2"
    ...
    Scenario: VRS Runs - create two TEST, same Run name, one is failed
        # First
        When I set env variables:
        """
        RUN_NAME: RUN-02
        ...
        Then I wait and refresh page on element "=RUN-02" for "3" seconds to exist
        Then I expect that element "//a[.='RUN-02']/../../div[@name='item-count']//span[@name='failedItems']" to have text "1"
        Then I expect that element "//a[.='RUN-02']/../../div[@name='item-count']//span[@name='totalItems']" to have text "3"
        When I click on the element "=RUN-02"
        Then the current url contains "RUN-02"
    ...
    Scenario: VRS Runs - First Run - 2 test, Second Run 1 test
        ...
        Then I expect that element "//a[.='RUN-03']/../../div[@name='item-count']//span[@name='failedItems']" to have text "0"
        Then I expect that element "//a[.='RUN-03']/../../div[@name='item-count']//span[@name='totalItems']" to have text "2"
        ...
        Then I expect that element "//a[.='RUN-04']/../../div[@name='item-count']//span[@name='failedItems']" to have text "0"
        Then I expect that element "//a[.='RUN-04']/../../div[@name='item-count']//span[@name='totalItems']" to have text "1"
