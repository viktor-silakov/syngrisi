...
function Check({
  ...
  const imageWeight = 24 * (parseInt(checksViewSize, 10) / 100);
  osIconMap(check.os);
  ...
  ((_a = check.diffId) == null ? void 0 : _a.filename) || ((_b = check.diffId) == null ? void 0 : _b.filename);
  const imagePreviewSrc = `${config.baseUri}/snapshoots/${(_c = check.baselineId) == null ? void 0 : _c.filename}`;
