    ...
    children: /* @__PURE__ */ jsx(Navbar, {
      ...
      children: /* @__PURE__ */ jsxs(Navbar.Section, {
        ...
        children: [/* @__PURE__ */ jsxs(Group, {
          ...
          num: 20
        }) : infinityQuery.status === "error" ? /* @__PURE__ */ jsxs(Text$1, {
          color: "red",
...
function AcceptButton({
  ...
  const notAcceptedButton = /* @__PURE__ */ jsx(Text, {
    component: "div",
    title: `Wrong images size`,
    pl: 4,
    pr: 4,
    pt: 6,
    pb: 6,
...
function Check({
  ...
  const failReasonsIcons = /* @__PURE__ */ jsx(Group, {
    children: check.failReasons.includes("not_accepted") && /* @__PURE__ */ jsx(lAe, {
      size: 14
    })
  });
      ...
      children: [/* @__PURE__ */ jsx(Paper, {
        ...
        children: [/* @__PURE__ */ jsx(Badge, {
          ...
          children: /* @__PURE__ */ jsxs(Group, {
            spacing: 0,
            noWrap: true,
            children: [check.status, failReasonsIcons]
          })
        }), /* @__PURE__ */ jsx(Text$1, {
          color: "dimmed",
          weight: 500,
          ...
          title: "Screen Viewport",
          sx: {
            display: checksViewSize === "small" ? "none" : "block"
          },
          children: check.viewport
        }), /* @__PURE__ */ jsxs(Group, {
          spacing: 4,
...
function Checks({
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: checksQuery.isLoading ? /* @__PURE__ */ jsx(ChecksSkeleton, {}) : checksQuery.isError ? /* @__PURE__ */ jsx(Text$1, {
      color: "red",
      size: "md",
      children: "Cannot load the data"
    }) : ((_d = (_c = checksQuery == null ? void 0 : checksQuery.data) == null ? void 0 : _c.results) == null ? void 0 : _d.length) < 1 ? /* @__PURE__ */ jsx(Text$1, {
      size: "md",
      ...
      children: /* @__PURE__ */ jsxs(Table, {
        ...
        children: [
          ...
          infinityQuery.isLoading ? /* @__PURE__ */ jsx(InfinityScrollSkeleton, {
            infinityQuery: null,
            visibleFields
          }) : infinityQuery.isError ? /* @__PURE__ */ jsxs(Text$1, {
            color: "red",
            children: ["Error:", infinityQuery.error.message]
          }) : /* @__PURE__ */ jsx("tbody", {
