import { r as react, b as jsx, d as useMantineTheme, ag as Global$1, ah as css, ai as useDidUpdate, aj as useReducedMotion, Y as useWindowEvent, ak as mergeRefs, al as reactDom, K as useComponentDefaultProps, V as extractSystemStyles, B as Box, J as getDefaultZIndex, am as OptionalPortal, an as packSx, s as ActionIcon, c as createStyles, j as jsxs, ao as createPolymorphicComponent, a5 as Fragment, T as Text, ap as _extends, aa as React, W as useUncontrolled, aq as useFloating, ar as size, as as useFloatingAutoUpdate, at as offset, au as arrow, av as shift, aw as flip, ax as inline, ay as isElement, az as useMergedRef, aA as clsx, L as Transition$2, aB as FloatingArrow, U as useId, aC as getFloatingPosition, aD as UnstyledButton, P as Paper, G as Group, aE as CheckIcon, aF as useTransition, aG as getTransitionStyles, R as Overlay, O as Loader, a0 as Tooltip, aH as useIsomorphicEffect$1, aI as useInputProps, X as Input, aJ as keyframes, aK as QueryObserver, aL as infiniteQueryBehavior, aM as hasNextPage, aN as hasPreviousPage, aO as Subscribable, aP as shallowEqualObjects, aQ as getDefaultState, aR as notifyManager, aS as parseMutationArgs, aT as useQueryClient, aU as useSyncExternalStore, aV as shouldThrowError, aW as parseQueryArgs, aX as useBaseQuery, aY as ReactDOM, aZ as Portal, l as log, a_ as NavigationContext, ad as useNavigate, a$ as useLocation, g as Button, h as Progress, D as useHotkeys, C as Center, p as TextInput, y as useLocalStorage, t as GCe, v as Nie, e as Container, k as ky, a as config$1, Z as queryString, u as useQuery, b0 as RD, b1 as Lqe, b2 as Iqe, b3 as I9, b4 as N9, b5 as P5, i as dj, b6 as NP, b7 as Qa, b8 as L3, b9 as CMe, ba as _He, bb as Iee, m as lAe, bc as commonjsGlobal, S as sizes$b, o as useForm, bd as rle, be as Nme } from "./use-form.214c851e.js";
...
function useClickOutside$1(handler, events, nodes) {
...
function useDisclosure(initialState, callbacks) {
  const [opened, setOpened2] = react.exports.useState(initialState);
  const open = () => {
    var _a;
    if (!opened) {
      setOpened2(true);
...
function useCollapse({
  ...
  const mergeStyles = (newStyles) => {
    setStyles((oldStyles) => __spreadValues$1B(__spreadValues$1B({}, oldStyles), newStyles));
  };
    ...
    if (opened) {
      raf(() => {
        ...
        raf(() => {
          ...
          mergeStyles(__spreadProps$J(__spreadValues$1B({}, getTransitionStyles2(height)), { height }));
        });
      });
    } else {
      raf(() => {
        const height = getElementHeight(el);
        mergeStyles(__spreadProps$J(__spreadValues$1B({}, getTransitionStyles2(height)), { willChange: "height", height }));
  ...
  function getCollapseProps(_a = {}) {
    var _b = _a, { style = {}, refKey = "ref" } = _b, rest = __objRest$14(_b, ["style", "refKey"]);
    const theirRef = rest[refKey];
    return __spreadProps$J(__spreadValues$1B({
      "aria-hidden": !opened
    }, rest), {
      [refKey]: mergeRefs(el, theirRef),
      onTransitionEnd: handleTransitionEnd,
      style: __spreadValues$1B(__spreadValues$1B({ boxSizing: "border-box" }, style), styles)
    });
  }
...
const Collapse = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Collapse", defaultProps$z, props), {
    children,
    in: opened,
    transitionDuration,
    ...
    onTransitionEnd,
    animateOpacity
  } = _a, others = __objRest$13(_a, ["children", "in", "transitionDuration", "transitionTimingFunction", "style", "onTransitionEnd", "animateOpacity"]);
  const theme = useMantineTheme();
  ...
  if (duration === 0) {
    return opened ? /* @__PURE__ */ jsx(Box, {
      ...__spreadValues$1A({}, rest),
      children
    }) : null;
  }
  return /* @__PURE__ */ jsx(Box, {
    ...__spreadValues$1A({}, getCollapseProps(__spreadValues$1A(__spreadValues$1A({
      style,
      ref
    }, rest), systemStyles))),
...
const Affix = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Affix", defaultProps$y, props), {
    target,
    position,
    zIndex,
    sx,
    withinPortal
  } = _a, others = __objRest$12(_a, ["target", "position", "zIndex", "sx", "withinPortal"]);
  return /* @__PURE__ */ jsx(OptionalPortal, {
    withinPortal,
    target,
    children: /* @__PURE__ */ jsx(Box, {
      ...__spreadValues$1z({
        sx: [__spreadValues$1z({
          position: "fixed",
          zIndex
        }, position), ...packSx(sx)],
        ref
...
const CloseButton = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("CloseButton", defaultProps$x, props), {
    iconSize,
    size: size2 = "md"
  } = _a, others = __objRest$11(_a, ["iconSize", "size"]);
  const theme = useMantineTheme();
...
var useStyles$1g = createStyles((theme, {
  ...
  return {
    root: __spreadProps$I(__spreadValues$1w(__spreadValues$1w(__spreadProps$I(__spreadValues$1w(__spreadValues$1w({}, theme.fn.fontStyles()), position), {
...
const HorizontalSection = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    __staticSelector,
    unstyled
  } = _b, others = __objRest$10(_b, ["width", "height", "fixed", "position", "zIndex", "hiddenBreakpoint", "hidden", "withBorder", "className", "classNames", "styles", "children", "section", "__staticSelector", "unstyled"]);
...
const _Section = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    grow = false,
    sx
  } = _b, others = __objRest$$(_b, ["children", "grow", "sx"]);
  return /* @__PURE__ */ jsx(Box, {
    ...__spreadValues$1u({
      ref,
      sx: [{
...
const Navbar = react.exports.forwardRef((props, ref) => {
  const _props = useComponentDefaultProps("Navbar", defaultProps$w, props);
...
var useStyles$1e = createStyles((theme, { height, fixed, position, zIndex, borderPosition }) => ({
  root: __spreadProps$H(__spreadValues$1s(__spreadValues$1s({}, theme.fn.fontStyles()), position), {
    zIndex,
    height,
    maxHeight: height,
    position: fixed ? "fixed" : "static",
...
const VerticalSection = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    unstyled,
    __staticSelector
  } = _b, others = __objRest$_(_b, ["children", "className", "classNames", "styles", "height", "fixed", "withBorder", "position", "zIndex", "section", "unstyled", "__staticSelector"]);
  const ctx = useAppShellContext();
  const {
    classes,
    cx
...
const Header = react.exports.forwardRef((props, ref) => {
  const _props = useComponentDefaultProps("Header", defaultProps$v, props);
  return /* @__PURE__ */ jsx(VerticalSection, {
    ...__spreadProps$G(__spreadValues$1q({
      section: "header",
...
var useStyles$1c = createStyles((theme, props) => ({
  root: {
    boxSizing: "border-box"
  },
  body: {
...
const AppShell = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("AppShell", defaultProps$u, props), {
    children,
    navbar,
    header,
    footer,
    ...
    unstyled,
    hidden: hidden2
  } = _a, others = __objRest$Z(_a, ["children", "navbar", "header", "footer", "aside", "fixed", "zIndex", "padding", "navbarOffsetBreakpoint", "asideOffsetBreakpoint", "className", "styles", "classNames", "unstyled", "hidden"]);
  const {
    classes,
    cx
  } = useStyles$1d({
...
var useStyles$1a = createStyles((theme, { size: size2, variant, color }) => ({
  root: {},
  withLabel: {
  ...
  label: {
    ...
    "&::before": {
      ...
      flex: 1,
      height: 1,
      borderTop: `${theme.fn.size({ size: size2, sizes: sizes$a })}px ${variant} ${getColor(theme, color)}`,
  ...
  horizontal: {
    border: 0,
    borderTopWidth: theme.fn.size({ size: size2, sizes: sizes$a }),
  ...
  vertical: {
    ...
    alignSelf: "stretch",
    height: "auto",
    borderLeftWidth: theme.fn.size({ size: size2, sizes: sizes$a }),
...
const Divider = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Divider", defaultProps$t, props), {
    ...
    classNames,
    unstyled
  } = _a, others = __objRest$Y(_a, ["className", "color", "orientation", "size", "label", "labelPosition", "labelProps", "variant", "styles", "classNames", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$1b({
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: withLabel && /* @__PURE__ */ jsx(Text, {
      ...__spreadProps$F(__spreadValues$1n({}, labelProps), {
...
var useStyles$18 = createStyles((theme, { size: size2 }) => ({
  item: __spreadProps$E(__spreadValues$1m({}, theme.fn.fontStyles()), {
    boxSizing: "border-box",
    textAlign: "left",
    width: "100%",
    ...
    "&[data-selected]": __spreadValues$1m({
...
const DefaultItem = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    label,
    value
  } = _b, others = __objRest$X(_b, ["label", "value"]);
...
var useStyles$16 = createStyles((theme, { scrollbarSize, offsetScrollbars, scrollbarHovered, hidden: hidden2 }, getRef) => ({
  root: {
    overflow: "hidden"
  },
  viewport: {
...
const _ScrollArea = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ScrollArea", defaultProps$s, props), {
    ...
    unstyled
  } = _a, others = __objRest$W(_a, ["children", "className", "classNames", "styles", "scrollbarSize", "scrollHideDelay", "type", "dir", "offsetScrollbars", "viewportRef", "onScrollPositionChange", "unstyled"]);
...
const ScrollAreaAutosize = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ScrollAreaAutosize", defaultProps$s, props), {
    ...
    unstyled,
    sx
  } = _a, others = __objRest$W(_a, ["maxHeight", "children", "classNames", "styles", "scrollbarSize", "scrollHideDelay", "type", "dir", "offsetScrollbars", "viewportRef", "onScrollPositionChange", "unstyled", "sx"]);
  return /* @__PURE__ */ React.createElement(Box, __spreadProps$D(__spreadValues$1j({}, others), {
    ref,
    sx: [{
      display: "flex",
      maxHeight
...
const SelectScrollArea = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    style
  } = _b, others = __objRest$V(_b, ["style"]);
  return /* @__PURE__ */ jsx(ScrollArea, {
    ...__spreadProps$C(__spreadValues$1i({}, others), {
...
function usePopover(options) {
  const [_opened, setOpened2] = useUncontrolled({
...
const PopoverTarget = react.exports.forwardRef((_a, ref) => {
  var _b = _a, { children, refProp = "ref", popupType = "dialog" } = _b, others = __objRest$U(_b, ["children", "refProp", "popupType"]);
  ...
  return react.exports.cloneElement(children, __spreadValues$1h(__spreadProps$B(__spreadValues$1h(__spreadValues$1h(__spreadValues$1h({}, forwardedProps), accessibleProps), ctx.targetProps), {
    className: clsx(ctx.targetProps.className, forwardedProps.className, children.props.className),
    [refProp]: targetRef
  }), !ctx.controlled ? { onClick: ctx.onToggle } : null));
});
PopoverTarget.displayName = "@mantine/core/PopoverTarget";
var useStyles$12 = createStyles((theme, { radius, shadow }) => ({
  dropdown: {
    position: "absolute",
...
function PopoverDropdown(_a) {
  var _b = _a, {
    ...
    children,
    onKeyDownCapture
  } = _b, others = __objRest$T(_b, ["style", "className", "children", "onKeyDownCapture"]);
  const {
    classNames,
    styles,
    unstyled,
    ...
    children: /* @__PURE__ */ jsx(Transition$2, {
      ...
      children: (transitionStyles) => {
        ...
        return /* @__PURE__ */ jsx(FocusTrap, {
          ...
          children: /* @__PURE__ */ jsxs(Box, {
            ...__spreadValues$1g(__spreadProps$A(__spreadValues$1g({}, accessibleProps), {
              tabIndex: -1,
              ref: ctx.floating,
              style: __spreadProps$A(__spreadValues$1g(__spreadValues$1g({}, style), transitionStyles), {
                zIndex: ctx.zIndex,
...
function Popover(props) {
  ...
  const _a = useComponentDefaultProps("Popover", defaultProps$r, props), {
    children,
    position,
    offset: offset2,
    onPositionChange,
  ...
  useClickOutside$1(() => closeOnClickOutside && popover.onClose(), clickOutsideEvents, [targetNode, dropdownNode]);
...
function SelectPopoverDropdown(_a) {
  var _b = _a, {
    ...
    classNames,
    unstyled
  } = _b, others = __objRest$R(_b, ["children", "component", "maxHeight", "direction", "id", "innerRef", "__staticSelector", "styles", "classNames", "unstyled"]);
  const {
    classes
  } = useStyles$15(null, {
    name: __staticSelector,
...
function AvatarPlaceholderIcon(props) {
  return /* @__PURE__ */ jsx("svg", {
    ...__spreadProps$z(__spreadValues$1e({}, props), {
      width: "15",
      height: "15",
      viewBox: "0 0 15 15",
      fill: "none",
...
function useAvatarGroupContext() {
  ...
  if (ctx) {
    return __spreadProps$y(__spreadValues$1d({}, ctx), {
      withinGroup: true
    });
  }
  return {
...
var useStyles$10 = createStyles((theme, { spacing }) => ({
  root: {
    display: "flex",
...
const AvatarGroup = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("AvatarGroup", defaultProps$q, props), {
    children,
    spacing = "sm",
    unstyled,
    className
  } = _a, others = __objRest$Q(_a, ["children", "spacing", "unstyled", "className"]);
  const {
    classes,
    cx
  } = useStyles$11({
...
var useStyles$_ = createStyles((theme, { size: size2, radius, color, withinGroup, spacing, variant, gradient }) => {
  const colors = theme.fn.variant({ variant, color, gradient });
  return {
    root: __spreadValues$1b(__spreadProps$x(__spreadValues$1b({}, theme.fn.focusStyles()), {
      ...
      minWidth: theme.fn.size({ size: size2, sizes: sizes$9 }),
    ...
    placeholder: __spreadProps$x(__spreadValues$1b({}, theme.fn.fontStyles()), {
      fontSize: theme.fn.size({ size: size2, sizes: sizes$9 }) / 2.5,
      color: colors.color,
      fontWeight: 700,
...
const _Avatar = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Avatar", defaultProps$p, props), {
    className,
    size: size2,
    src,
    alt,
    ...
    imageProps,
    unstyled
  } = _a, others = __objRest$P(_a, ["className", "size", "src", "alt", "radius", "children", "color", "variant", "gradient", "classNames", "styles", "imageProps", "unstyled"]);
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: error ? /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$w(__spreadValues$1a({}, imageProps), {
...
var useStyles$Y = createStyles((theme, { color, size: size2, radius, gradient, fullWidth, variant }) => {
  const { fontSize, height } = size2 in sizes$8 ? sizes$8[size2] : sizes$8.md;
  return {
    leftSection: {
    ...
    root: __spreadValues$19(__spreadProps$v(__spreadValues$19(__spreadValues$19({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
      fontSize,
      height,
      WebkitTapHighlightColor: "transparent",
...
const _Badge = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Badge", defaultProps$o, props), {
    ...
    styles,
    unstyled
  } = _a, others = __objRest$O(_a, ["className", "color", "variant", "fullWidth", "children", "size", "leftSection", "rightSection", "radius", "gradient", "classNames", "styles", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$Z({
...
const Breadcrumbs = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Breadcrumbs", defaultProps$n, props), {
    className,
    children,
    separator,
    classNames,
    styles,
    unstyled
  } = _a, others = __objRest$N(_a, ["className", "children", "separator", "classNames", "styles", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$X(null, {
...
var useStyles$U = createStyles((theme, { size: size2, color, transitionDuration }) => {
  const sizeValue = theme.fn.size({ size: size2, sizes: sizes$7 });
...
const Burger = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Burger", defaultProps$m, props), {
    className,
    opened,
    color,
    size: size2,
    ...
    styles,
    transitionDuration
  } = _a, others = __objRest$M(_a, ["className", "opened", "color", "size", "classNames", "styles", "transitionDuration"]);
  const {
    classes,
    cx
  } = useStyles$V({
...
var useStyles$S = createStyles((theme, { padding: padding2, withBorder, inheritPadding }) => {
...
const _CardSection = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    unstyled
  } = _b, others = __objRest$L(_b, ["className", "withBorder", "inheritPadding", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$T({
...
const _Card = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Card", defaultProps$l, props), {
    ...
    children,
    unstyled
  } = _a, others = __objRest$K(_a, ["className", "p", "radius", "children", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$R(null, {
...
function ChipGroup(props) {
  const _a = useComponentDefaultProps("ChipGroup", defaultProps$k, props), {
    ...
    children,
    unstyled
  } = _a, others = __objRest$J(_a, ["value", "defaultValue", "onChange", "spacing", "multiple", "children", "unstyled"]);
...
var useStyles$O = createStyles((theme, { radius, size: size2, color }, getRef) => ({
  root: {},
  label: __spreadProps$u(__spreadValues$12({
    ref: getRef("label")
  }, theme.fn.fontStyles()), {
    boxSizing: "border-box",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    ...
    fontSize: theme.fn.size({ size: size2, sizes: theme.fontSizes }),
    lineHeight: `${theme.fn.size({ size: size2, sizes: sizes$6 }) - 2}px`,
    ...
    WebkitTapHighlightColor: "transparent",
    '&[data-variant="filled"]': __spreadValues$12({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[4] : theme.colors.gray[1]
    }, theme.fn.hover({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.colors.gray[0]
    })),
    '&[data-variant="outline"]': __spreadValues$12({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[6] : theme.white,
      borderColor: theme.colorScheme === "dark" ? theme.colors.dark[4] : theme.colors.gray[4]
    }, theme.fn.hover({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.colors.gray[0]
    })),
    "&[data-disabled]": __spreadProps$u(__spreadValues$12({
...
const Chip = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Chip", defaultProps$j, props), {
    ...
    value,
    unstyled
  } = _a, others = __objRest$I(_a, ["radius", "type", "size", "variant", "disabled", "id", "color", "children", "className", "classNames", "style", "styles", "checked", "defaultChecked", "onChange", "sx", "wrapperProps", "value", "unstyled"]);
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...__spreadValues$11(__spreadValues$11({
      className: cx(classes.root, className),
      style,
      sx
...
var useStyles$M = createStyles((theme, { color }) => ({
  root: {
...
const Mark = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Mark", defaultProps$i, props), {
    color,
    className,
    unstyled
  } = _a, others = __objRest$H(_a, ["color", "className", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$N({
...
const _Highlight = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Highlight", defaultProps$h, props), {
    children,
    highlight,
    highlightColor,
    highlightStyles,
    unstyled
  } = _a, others = __objRest$G(_a, ["children", "highlight", "highlightColor", "highlightStyles", "unstyled"]);
...
var useStyles$K = createStyles((theme, { radius }) => ({
  root: {},
  imageWrapper: {
    position: "relative"
  },
  ...
  image: __spreadProps$t(__spreadValues$Z({}, theme.fn.fontStyles()), {
    display: "block",
    width: "100%",
    height: "100%",
    border: 0,
  ...
  placeholder: __spreadProps$t(__spreadValues$Z({}, theme.fn.cover()), {
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
...
const Image = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Image", defaultProps$g, props), {
    className,
    alt,
    src,
    fit,
    ...
    unstyled,
    style
  } = _a, others = __objRest$F(_a, ["className", "alt", "src", "fit", "width", "height", "radius", "imageProps", "withPlaceholder", "placeholder", "imageRef", "classNames", "styles", "caption", "unstyled", "style"]);
  const {
    classes,
    cx
  } = useStyles$L({
...
const Kbd = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Kbd", {}, props), {
    ...
    children,
    unstyled
  } = _a, others = __objRest$E(_a, ["className", "children", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$J(null, {
...
var useStyles$G = createStyles((theme, { spacing, center }, getRef) => ({
  itemWrapper: {
...
function ListItem(_a) {
  var _b = _a, {
    ...
    children,
    icon
  } = _b, others = __objRest$D(_b, ["className", "children", "icon"]);
  const {
    icon: ctxIcon,
    spacing,
    center,
...
var useStyles$E = createStyles((theme, { withPadding, size: size2, listStyleType }) => ({
  root: __spreadProps$s(__spreadValues$V({}, theme.fn.fontStyles()), {
    listStyleType,
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    fontSize: theme.fn.size({ size: size2, sizes: theme.fontSizes }),
    lineHeight: theme.lineHeight,
...
const List = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("List", defaultProps$f, props), {
    children,
    type,
    size: size2,
    listStyleType,
    ...
    classNames,
    unstyled
  } = _a, others = __objRest$C(_a, ["children", "type", "size", "listStyleType", "withPadding", "center", "spacing", "icon", "className", "styles", "classNames", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$F({
...
var useStyles$A = createStyles((theme, { color, radius }) => ({
  item: __spreadProps$r(__spreadValues$R({}, theme.fn.fontStyles()), {
    WebkitTapHighlightColor: "transparent",
...
const _MenuItem = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    icon,
    rightSection
  } = _b, others = __objRest$z(_b, ["children", "className", "color", "closeMenuOnClick", "icon", "rightSection"]);
  const ctx = useMenuContext();
  const {
    classNames,
    styles,
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...__spreadProps$q(__spreadValues$Q({
      component: "button"
    }, others), {
      type: "button",
      tabIndex: -1,
...
function Menu(props) {
  const _a = useComponentDefaultProps("Menu", defaultProps$e, props), {
    children,
    onOpen,
    onClose,
    opened,
    ...
    unstyled,
    radius
  } = _a, others = __objRest$w(_a, ["children", "onOpen", "onClose", "opened", "defaultOpened", "onChange", "closeOnItemClick", "loop", "closeOnEscape", "trigger", "openDelay", "closeDelay", "classNames", "styles", "unstyled", "radius"]);
  const {
    classes,
    cx
  } = useStyles$x();
  ...
  return /* @__PURE__ */ jsx(MenuContextProvider, {
    ...
    children: /* @__PURE__ */ jsx(Popover, {
      ...__spreadProps$p(__spreadValues$N({}, others), {
        radius,
        opened: _opened,
        onChange: setOpened2,
        defaultOpened,
...
var useStyles$u = createStyles((theme, { overflow, size: size2, centered, zIndex, fullScreen }) => ({
  close: {},
  overlay: {
  ...
  modal: __spreadValues$M({
    position: "relative",
    width: fullScreen ? "100vw" : theme.fn.size({ sizes: sizes$5, size: size2 }),
...
function Modal(props) {
  const _a = useComponentDefaultProps("Modal", defaultProps$d, props), {
    className,
    opened,
    title,
    onClose,
...
function ChevronIcon(_a) {
  var _b = _a, {
    ...
    error,
    style
  } = _b, others = __objRest$u(_b, ["size", "error", "style"]);
  const theme = useMantineTheme();
...
function getSelectRightSectionProps(_a) {
  var _b = _a, {
    ...
    rightSectionWidth,
    theme
  } = _b, props = __objRest$t(_b, ["styles", "rightSection", "rightSectionWidth", "theme"]);
  if (rightSection) {
    return {
      rightSection,
      rightSectionWidth,
  ...
  return {
    ...
    rightSection: !props.readOnly && !(props.disabled && props.shouldClear) && /* @__PURE__ */ jsx(SelectRightSection, {
      ...__spreadValues$J({}, props)
    }),
    styles: __spreadProps$o(__spreadValues$J({}, _styles), {
      rightSection: __spreadProps$o(__spreadValues$J({}, _styles == null ? void 0 : _styles.rightSection), {
...
const Notification = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Notification", {}, props), {
    ...
    styles,
    unstyled
  } = _a, others = __objRest$s(_a, ["className", "color", "radius", "loading", "disallowClose", "title", "icon", "children", "onClose", "closeButtonProps", "classNames", "styles", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$t({
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [icon && !loading && /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$n(__spreadValues$I({
        iconSize: 16,
        color: "gray"
      }, closeButtonProps), {
        onClick: onClose,
...
function getCurves({ size: size2, thickness, sections, renderRoundedLineCaps }) {
  ...
  curvesInOrder.push(__spreadProps$m(__spreadValues$G({}, curves[curves.length - 1]), { lineRoundCaps: false }));
  if (curves.length > 2) {
    curvesInOrder.push(__spreadProps$m(__spreadValues$G({}, curves[0]), { lineRoundCaps: renderRoundedLineCaps }));
    curvesInOrder.push(__spreadProps$m(__spreadValues$G({}, curves[curves.length - 2]), { lineRoundCaps: renderRoundedLineCaps }));
    for (let i = 1; i <= curves.length - 3; i += 1) {
      curvesInOrder.push(__spreadProps$m(__spreadValues$G({}, curves[i]), { lineRoundCaps: false }));
    }
  } else {
    curvesInOrder.push(__spreadProps$m(__spreadValues$G({}, curves[0]), { lineRoundCaps: renderRoundedLineCaps }));
  }
...
const RingProgress = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("RingProgress", defaultProps$c, props), {
    className,
    style,
    label,
    sections,
...
var useStyles$o = createStyles((theme, {
  ...
  const colors = theme.fn.variant({ variant: "filled", color });
  return {
    label: __spreadProps$l(__spreadValues$E(__spreadValues$E({
      ref: getRef("label")
      ...
      display: "block",
      textAlign: "center",
      padding: sizes$4[size2 in sizes$4 ? size2 : "sm"],
      whiteSpace: "nowrap",
      overflow: "hidden",
      textOverflow: "ellipsis",
      userSelect: "none",
...
const Select = react.exports.forwardRef((props, ref) => {
  const _a = useInputProps("Select", defaultProps$a, props), {
    inputProps,
    wrapperProps,
    shadow,
    data,
  ...
  return /* @__PURE__ */ jsx(Input.Wrapper, {
    ...__spreadProps$k(__spreadValues$C({}, wrapperProps), {
      ...
      children: [/* @__PURE__ */ jsx(SelectPopover.Target, {
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx("input", {
            ...
            ...__spreadValues$C(__spreadProps$k(__spreadValues$C(__spreadValues$C({
              autoComplete: "off",
              type: "search"
            }, inputProps), others), {
              ...
              name: null,
              classNames: __spreadProps$k(__spreadValues$C({}, classNames), {
                input: cx({
...
var useStyles$k = createStyles((theme, { height, width, radius, circle, animate }) => ({
  root: {
    height,
...
const Skeleton = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Skeleton", defaultProps$9, props), {
    height,
    width,
    visible: visible2,
    animate,
    ...
    radius,
    unstyled
  } = _a, others = __objRest$o(_a, ["height", "width", "visible", "animate", "className", "circle", "radius", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$l({
...
const Table = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Table", defaultProps$8, props), {
    className,
    children,
    striped,
    highlightOnHover,
    ...
    withBorder,
    withColumnBorders
  } = _a, others = __objRest$n(_a, ["className", "children", "striped", "highlightOnHover", "captionSide", "horizontalSpacing", "verticalSpacing", "fontSize", "unstyled", "withBorder", "withColumnBorders"]);
  const {
    classes,
    cx
  } = useStyles$j({
...
const ReactRouter6Adapter = ({
  ...
  const { navigator } = react.exports.useContext(NavigationContext);
...
var useStyles$1 = createStyles((theme, { size: size2 }) => ({
  ...
  controls: {
    display: "flex",
    alignItems: "center",
    height: theme.fn.size({ size: size2, sizes: sizes$b }) - 2
  }
}));
...
export {
  ...
  UserMenu as U,
  useNavProgressFetchEffect as V,
  AppShell as W,
  ReactQueryDevtools as X,
  navigationData as Y,
  SpotlightProvider as Z,
  NotificationsProvider as _,
  useColorScheme as a,
  ModalsProvider as a0,
  QueryParamProvider as a1,
  ReactRouter6Adapter as a2,
  clamp as a3,
  createSafeContext as a4,
  useContextStylesApi as a5,
  createScopedKeydownHandler as a6,
  StylesApiProvider as a7,
  CloseButton as a8,
  HorizontalSection as a9,
  ChevronIcon as aA,
  Global as aB,
  AppContext as aC,
  UserHooks as aD,
  Section as aa,
  VerticalSection as ab,
  DefaultItem as ac,
  groupOptions as ad,
  SelectPopover as ae,
  SelectScrollArea as af,
  SelectItems as ag,
  Popover as ah,
  useFocusTrap as ai,
  useScrollLock as aj,
  useFocusReturn as ak,
  GroupedTransition as al,
  createEventHandler as am,
  useDelayedHover as an,
  _objectWithoutPropertiesLoose as ao,
  useScrollIntoView as ap,
  getSelectRightSectionProps as aq,
  useElementSize as ar,
  Divider as as,
  Avatar as at,
  CardSection as au,
  Highlight as av,
