import { r as react, b as jsx, d as useMantineTheme, au as Global$1, av as css, aw as useDidUpdate, ax as useReducedMotion, ay as useWindowEvent, az as mergeRefs, aA as reactDom, O as useComponentDefaultProps, S as extractSystemStyles, B as Box, aB as getDefaultZIndex, aC as OptionalPortal, aD as packSx, t as ActionIcon, aE as createPolymorphicComponent, c as createStyles, j as jsxs, $ as Fragment, T as Text, aF as _extends, a3 as React, U as useUncontrolled, aG as useFloating, aH as size, aI as useFloatingAutoUpdate, aJ as offset, aK as arrow, aL as shift, aM as limitShift, aN as flip, aO as inline, aP as isElement, aQ as useMergedRef, aR as clsx, a4 as Transition$2, aS as FloatingArrow, R as useId, aT as getFloatingPosition, aU as UnstyledButton, P as Paper, G as Group, aV as CheckIcon, aW as useTransition, aX as getTransitionStyles, aY as Overlay, a2 as Loader, a0 as Tooltip, aZ as useIsomorphicEffect$1, a_ as useInputProps, V as Input, a$ as keyframes, b0 as InputsGroup, b1 as InlineInput, b2 as QueryObserver, b3 as infiniteQueryBehavior, b4 as hasNextPage, b5 as hasPreviousPage, b6 as Subscribable, b7 as shallowEqualObjects, b8 as getDefaultState, b9 as notifyManager, ba as parseMutationArgs, bb as useQueryClient, bc as useSyncExternalStore, bd as shouldThrowError, be as parseQueryArgs, bf as useBaseQuery, bg as ReactDOM, bh as Portal, l as log, bi as NavigationContext, ar as useNavigate, bj as useLocation, i as Progress, C as Center, q as TextInput, E as useHotkeys, e as Container, k as ky, a as config$1, W as queryString, u as useQuery, bk as B9, bl as wue, bm as gW, bn as wz, bo as mF, bp as Uye, z as zB, bq as Lqe, br as Iqe, bs as I9, bt as N9, h as Button, bu as P5, m as dj, bv as NP, bw as Qa, v as GCe, x as Nie, D as useLocalStorage, bx as L3, by as CMe, bz as _He, bA as Iee, n as lAe, bB as commonjsGlobal, K as sizes$c, p as useForm, bC as rle, bD as Nme } from "./use-form.eecc9fb9.js";
...
function useCollapse({
  ...
  const mergeStyles = (newStyles) => {
    setStyles((oldStyles) => __spreadValues$1F(__spreadValues$1F({}, oldStyles), newStyles));
  };
    ...
    if (opened) {
      raf(() => {
        ...
        raf(() => {
          ...
          mergeStyles(__spreadProps$M(__spreadValues$1F({}, getTransitionStyles2(height)), { height }));
        });
      });
    } else {
      raf(() => {
        const height = getElementHeight(el);
        mergeStyles(__spreadProps$M(__spreadValues$1F({}, getTransitionStyles2(height)), { willChange: "height", height }));
  ...
  function getCollapseProps(_a = {}) {
    ...
    return __spreadProps$M(__spreadValues$1F({
      "aria-hidden": !opened
    }, rest), {
      [refKey]: mergeRefs(el, theirRef),
      onTransitionEnd: handleTransitionEnd,
      style: __spreadValues$1F(__spreadValues$1F({ boxSizing: "border-box" }, style), styles)
    });
  }
...
const Collapse = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Collapse", defaultProps$M, props), {
    children,
    in: opened,
    transitionDuration,
  ...
  if (duration === 0) {
    return opened ? /* @__PURE__ */ jsx(Box, {
      ...__spreadValues$1E({}, rest),
      children
    }) : null;
  }
  return /* @__PURE__ */ jsx(Box, {
    ...__spreadValues$1E({}, getCollapseProps(__spreadValues$1E(__spreadValues$1E({
      style,
      ref
    }, rest), systemStyles))),
...
const Affix = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Affix", defaultProps$L, props), {
    target,
    position,
    zIndex,
    sx,
...
const _CloseButton = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("CloseButton", defaultProps$K, props), {
    iconSize,
    size: size2 = "md"
...
var useStyles$1k = createStyles((theme, {
  ...
  return {
    root: __spreadProps$L(__spreadValues$1A(__spreadValues$1A(__spreadProps$L(__spreadValues$1A(__spreadValues$1A({}, theme.fn.fontStyles()), position), {
...
const Navbar = react.exports.forwardRef((props, ref) => {
  const _props = useComponentDefaultProps("Navbar", defaultProps$J, props);
...
var useStyles$1i = createStyles((theme, { height, fixed, position, zIndex, borderPosition, layout }) => {
  ...
  return {
    root: __spreadProps$K(__spreadValues$1w(__spreadProps$K(__spreadValues$1w(__spreadValues$1w({}, theme.fn.fontStyles()), position), {
      zIndex,
...
const Header = react.exports.forwardRef((props, ref) => {
  const _props = useComponentDefaultProps("Header", defaultProps$I, props);
  return /* @__PURE__ */ jsx(VerticalSection, {
    ...__spreadProps$J(__spreadValues$1u({
      section: "header",
...
const AppShell = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("AppShell", defaultProps$H, props), {
    children,
    navbar,
    header,
    footer,
    ...
    hidden: hidden2,
    layout
  } = _a, others = __objRest$11(_a, ["children", "navbar", "header", "footer", "aside", "fixed", "zIndex", "padding", "navbarOffsetBreakpoint", "asideOffsetBreakpoint", "className", "styles", "classNames", "unstyled", "hidden", "layout"]);
  const {
    classes,
    cx
  } = useStyles$1h({
...
const Divider = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Divider", defaultProps$G, props), {
    className,
    color,
    orientation,
    size: size2,
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: withLabel && /* @__PURE__ */ jsx(Text, {
      ...__spreadProps$I(__spreadValues$1r({}, labelProps), {
...
var useStyles$1c = createStyles((theme, { size: size2 }) => ({
  item: __spreadProps$H(__spreadValues$1q({}, theme.fn.fontStyles()), {
    boxSizing: "border-box",
    textAlign: "left",
    width: "100%",
    ...
    "&[data-selected]": __spreadValues$1q({
...
const _ScrollArea = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ScrollArea", defaultProps$F, props), {
    children,
    className,
    classNames,
    styles,
...
const ScrollAreaAutosize = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ScrollAreaAutosize", defaultProps$F, props), {
    maxHeight,
    children,
    classNames,
    styles,
  ...
  return /* @__PURE__ */ React.createElement(Box, __spreadProps$G(__spreadValues$1n({}, others), {
    ref,
    sx: [{
      display: "flex",
      maxHeight
...
const SelectScrollArea = react.exports.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsx(ScrollArea, {
    ...__spreadProps$F(__spreadValues$1m({}, others), {
      style: __spreadValues$1m({
        width: "100%"
      }, style),
      viewportRef: ref
    }),
...
const PopoverTarget = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("PopoverTarget", defaultProps$E, props), { children, refProp, popupType } = _a, others = __objRest$Y(_a, ["children", "refProp", "popupType"]);
  ...
  return react.exports.cloneElement(children, __spreadValues$1l(__spreadProps$E(__spreadValues$1l(__spreadValues$1l(__spreadValues$1l({}, forwardedProps), accessibleProps), ctx.targetProps), {
...
function PopoverDropdown(props) {
  const _a = useComponentDefaultProps("PopoverDropdown", defaultProps$D, props), {
    style,
    className,
    children,
    onKeyDownCapture
  } = _a, others = __objRest$X(_a, ["style", "className", "children", "onKeyDownCapture"]);
  const ctx = usePopoverContext();
  const {
    classes,
    cx
    ...
    children: /* @__PURE__ */ jsx(Transition$2, {
      ...
      children: (transitionStyles) => {
        ...
        return /* @__PURE__ */ jsx(FocusTrap, {
          ...
          children: /* @__PURE__ */ jsxs(Box, {
            ...__spreadValues$1k(__spreadProps$D(__spreadValues$1k({}, accessibleProps), {
              tabIndex: -1,
              key: ctx.placement,
              ref: ctx.floating,
              style: __spreadProps$D(__spreadValues$1k(__spreadValues$1k({}, style), transitionStyles), {
                zIndex: ctx.zIndex,
...
function Popover(props) {
  ...
  const _a = useComponentDefaultProps("Popover", defaultProps$C, props), {
    children,
    position,
    offset: offset2,
    onPositionChange,
...
function AvatarPlaceholderIcon(props) {
  return /* @__PURE__ */ jsx("svg", {
    ...__spreadProps$C(__spreadValues$1i({}, props), {
      width: "15",
      height: "15",
      viewBox: "0 0 15 15",
      fill: "none",
...
function useAvatarGroupContext() {
  ...
  if (ctx) {
    return __spreadProps$B(__spreadValues$1h({}, ctx), {
      withinGroup: true
    });
  }
  return {
...
const AvatarGroup = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("AvatarGroup", defaultProps$B, props), {
    children,
    spacing = "sm",
    unstyled,
    className
...
var useStyles$12 = createStyles((theme, { size: size2, radius, color, withinGroup, spacing, variant, gradient }) => {
  ...
  return {
    root: __spreadValues$1f(__spreadProps$A(__spreadValues$1f({}, theme.fn.focusStyles()), {
    ...
    placeholder: __spreadProps$A(__spreadValues$1f({}, theme.fn.fontStyles()), {
...
const _Avatar = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Avatar", defaultProps$A, props), {
    className,
    size: size2,
    src,
    alt,
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: error ? /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$z(__spreadValues$1e({}, imageProps), {
...
var useStyles$10 = createStyles((theme, { color, size: size2, radius, gradient, fullWidth, variant }) => {
  ...
  return {
    ...
    root: __spreadValues$1d(__spreadProps$y(__spreadValues$1d(__spreadValues$1d({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
      fontSize,
      height,
      WebkitTapHighlightColor: "transparent",
...
const _Badge = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Badge", defaultProps$z, props), {
    className,
    color,
    variant,
    fullWidth,
...
const Breadcrumbs = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Breadcrumbs", defaultProps$y, props), {
    className,
    children,
    separator,
    classNames,
...
const Burger = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Burger", defaultProps$x, props), {
    className,
    opened,
    color,
    size: size2,
...
const _CardSection = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("CardSection", defaultProps$w, props), {
    className,
    withBorder,
    inheritPadding,
    unstyled
  } = _a, others = __objRest$P(_a, ["className", "withBorder", "inheritPadding", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$X({
...
const _Card = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Card", defaultProps$v, props), {
    className,
    p,
    radius,
    children,
...
function ChipGroup(props) {
  const _a = useComponentDefaultProps("ChipGroup", defaultProps$u, props), {
    value,
    defaultValue,
    onChange,
    spacing,
...
var useStyles$S = createStyles((theme, { radius, size: size2, color }, getRef) => ({
  root: {},
  label: __spreadProps$x(__spreadValues$16({
    ref: getRef("label")
  }, theme.fn.fontStyles()), {
    boxSizing: "border-box",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    ...
    WebkitTapHighlightColor: "transparent",
    '&[data-variant="filled"]': __spreadValues$16({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[4] : theme.colors.gray[1]
    }, theme.fn.hover({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.colors.gray[0]
    })),
    '&[data-variant="outline"]': __spreadValues$16({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[6] : theme.white,
      borderColor: theme.colorScheme === "dark" ? theme.colors.dark[4] : theme.colors.gray[4]
    }, theme.fn.hover({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.colors.gray[0]
    })),
    "&[data-disabled]": __spreadProps$x(__spreadValues$16({
  ...
  input: {
    ...
    "&:focus": {
      outline: "none",
      [`& + .${getRef("label")}`]: __spreadValues$16({}, theme.focusRing === "always" || theme.focusRing === "auto" ? theme.focusRingStyles.styles(theme) : theme.focusRingStyles.resetStyles(theme)),
      "&:focus:not(:focus-visible)": {
        [`& + .${getRef("label")}`]: __spreadValues$16({}, theme.focusRing === "auto" || theme.focusRing === "never" ? theme.focusRingStyles.resetStyles(theme) : null)
      }
    }
  }
}));
...
const Chip = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Chip", defaultProps$t, props), {
    radius,
    type,
    size: size2,
    variant,
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...__spreadValues$15(__spreadValues$15({
      className: cx(classes.root, className),
      style,
      sx
...
function CopyButton(props) {
  const _a = useComponentDefaultProps("CopyButton", defaultProps$s, props), {
    children,
    timeout,
    value
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: children(__spreadValues$14({
      copy,
...
const Mark = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Mark", defaultProps$r, props), {
    color,
    className,
    unstyled
...
const _Highlight = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Highlight", defaultProps$q, props), {
    children,
    highlight,
    highlightColor,
    highlightStyles,
...
var useStyles$O = createStyles((theme, { radius }) => ({
  ...
  image: __spreadProps$w(__spreadValues$10({}, theme.fn.fontStyles()), {
    display: "block",
    width: "100%",
    height: "100%",
    border: 0,
  ...
  placeholder: __spreadProps$w(__spreadValues$10({}, theme.fn.cover()), {
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
...
const ListItem = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ListItem", defaultProps$o, props), {
    className,
    children,
    icon
  } = _a, others = __objRest$G(_a, ["className", "children", "icon"]);
  const {
    icon: ctxIcon,
    spacing,
    center,
...
var useStyles$I = createStyles((theme, { withPadding, size: size2, listStyleType }) => ({
  root: __spreadProps$v(__spreadValues$Y({}, theme.fn.fontStyles()), {
    listStyleType,
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    fontSize: theme.fn.size({ size: size2, sizes: theme.fontSizes }),
    lineHeight: theme.lineHeight,
...
const List = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("List", defaultProps$n, props), {
    children,
    type,
    size: size2,
    listStyleType,
...
const MenuDivider = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("MenuDivider", defaultProps$m, props), {
    children,
    className
  } = _a, others = __objRest$E(_a, ["children", "className"]);
  const {
    classNames,
    styles,
    unstyled
...
function MenuDropdown(props) {
  const _a = useComponentDefaultProps("MenuDropdown", defaultProps$l, props), {
    children,
    onMouseEnter,
    onMouseLeave
  } = _a, others = __objRest$D(_a, ["children", "onMouseEnter", "onMouseLeave"]);
...
var useStyles$E = createStyles((theme, { color, radius }) => ({
  item: __spreadProps$u(__spreadValues$U({}, theme.fn.fontStyles()), {
    WebkitTapHighlightColor: "transparent",
...
const _MenuItem = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("MenuItem", defaultProps$k, props), {
    children,
    className,
    color,
    closeMenuOnClick,
    icon,
    rightSection
  } = _a, others = __objRest$C(_a, ["children", "className", "color", "closeMenuOnClick", "icon", "rightSection"]);
  const ctx = useMenuContext();
  const {
    classes,
    cx,
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...__spreadProps$t(__spreadValues$T({
      component: "button",
      type: "button"
    }, others), {
      tabIndex: -1,
...
const MenuLabel = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("MenuLabel", defaultProps$j, props), {
    children,
    className
  } = _a, others = __objRest$B(_a, ["children", "className"]);
  const {
    classNames,
    styles,
    unstyled
...
const MenuTarget = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("MenuTarget", defaultProps$i, props), {
    children,
    refProp
  } = _a, others = __objRest$A(_a, ["children", "refProp"]);
  if (!isElement(children)) {
...
function Menu(props) {
  ...
  return /* @__PURE__ */ jsx(MenuContextProvider, {
    ...
    children: /* @__PURE__ */ jsx(Popover, {
      ...__spreadProps$s(__spreadValues$Q({}, others), {
        radius,
        opened: _opened,
        onChange: setOpened,
        defaultOpened,
        ...
        classNames: __spreadProps$s(__spreadValues$Q({}, classNames), {
...
function getSelectRightSectionProps(_a) {
  ...
  return {
    ...
    rightSection: !props.readOnly && !(props.disabled && props.shouldClear) && /* @__PURE__ */ jsx(SelectRightSection, {
      ...__spreadValues$M({}, props)
    }),
    styles: __spreadProps$r(__spreadValues$M({}, _styles), {
      rightSection: __spreadProps$r(__spreadValues$M({}, _styles == null ? void 0 : _styles.rightSection), {
...
const Notification = react.exports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [icon && !loading && /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$q(__spreadValues$L({
        iconSize: 16,
        color: "gray"
      }, closeButtonProps), {
        onClick: onClose,
...
function Curve(_a) {
  var _b = _a, {
    ...
    lineRoundCaps,
    tooltip
  } = _b, others = __objRest$u(_b, ["size", "value", "offset", "sum", "thickness", "root", "color", "lineRoundCaps", "tooltip"]);
  const theme = useMantineTheme();
  ...
  return /* @__PURE__ */ jsx(Tooltip.Floating, {
    ...
    children: /* @__PURE__ */ jsx("circle", {
      ...__spreadValues$K(__spreadProps$p(__spreadValues$K({}, others), {
        fill: "none",
...
function getCurves({ size: size2, thickness, sections, renderRoundedLineCaps }) {
  ...
  curvesInOrder.push(__spreadProps$o(__spreadValues$J({}, curves[curves.length - 1]), { lineRoundCaps: false }));
  if (curves.length > 2) {
    curvesInOrder.push(__spreadProps$o(__spreadValues$J({}, curves[0]), { lineRoundCaps: renderRoundedLineCaps }));
    curvesInOrder.push(__spreadProps$o(__spreadValues$J({}, curves[curves.length - 2]), { lineRoundCaps: renderRoundedLineCaps }));
    for (let i = 1; i <= curves.length - 3; i += 1) {
      curvesInOrder.push(__spreadProps$o(__spreadValues$J({}, curves[i]), { lineRoundCaps: false }));
    }
  } else {
    curvesInOrder.push(__spreadProps$o(__spreadValues$J({}, curves[0]), { lineRoundCaps: renderRoundedLineCaps }));
  }
...
const RingProgress = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("RingProgress", defaultProps$f, props), {
    ...
    roundCaps,
    unstyled
  } = _a, others = __objRest$t(_a, ["className", "style", "label", "sections", "size", "thickness", "classNames", "styles", "roundCaps", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$v(null, {
  ...
  const curves = getCurves({
    ...
    ...__spreadProps$n(__spreadValues$I({}, data), {
      key: index,
...
var useStyles$s = createStyles((theme, {
  ...
  const colors = theme.fn.variant({ variant: "filled", color });
  return {
    label: __spreadProps$m(__spreadValues$H(__spreadValues$H({
      ref: getRef("label")
    ...
    input: {
      ...
      "&:focus": {
        outline: "none",
        [`& + .${getRef("label")}`]: __spreadValues$H({}, theme.focusRing === "always" || theme.focusRing === "auto" ? theme.focusRingStyles.styles(theme) : theme.focusRingStyles.resetStyles(theme)),
        "&:focus:not(:focus-visible)": {
          [`& + .${getRef("label")}`]: __spreadValues$H({}, theme.focusRing === "auto" || theme.focusRing === "never" ? theme.focusRingStyles.resetStyles(theme) : null)
        }
      }
    },
    root: {
...
const SegmentedControl = react.exports.forwardRef((props, ref) => {
  ...
  const _a = useComponentDefaultProps("SegmentedControl", defaultProps$e, props), {
    ...
    orientation,
    unstyled
  } = _a, others = __objRest$s(_a, ["className", "disabled", "data", "name", "value", "onChange", "color", "fullWidth", "radius", "size", "transitionDuration", "transitionTimingFunction", "classNames", "styles", "defaultValue", "orientation", "unstyled"]);
  const theme = useMantineTheme();
  const shouldReduceMotion = useReducedMotion();
  const reduceMotion = theme.respectReducedMotion ? shouldReduceMotion : false;
...
const Select = react.exports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsx(Input.Wrapper, {
    ...__spreadProps$l(__spreadValues$F({}, wrapperProps), {
      ...
      children: [/* @__PURE__ */ jsx(SelectPopover.Target, {
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx("input", {
            ...
            ...__spreadValues$F(__spreadProps$l(__spreadValues$F(__spreadValues$F({
              autoComplete: "off",
              type: "search"
            }, inputProps), others), {
              ...
              name: null,
              classNames: __spreadProps$l(__spreadValues$F({}, classNames), {
                input: cx({
...
const Skeleton = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Skeleton", defaultProps$c, props), {
    ...
    radius,
    unstyled
  } = _a, others = __objRest$q(_a, ["height", "width", "visible", "animate", "className", "circle", "radius", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$p({
...
const SwitchGroup = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("SwitchGroup", defaultProps$b, props), {
    ...
    wrapperProps,
    offset: offset2
  } = _a, others = __objRest$p(_a, ["children", "value", "defaultValue", "onChange", "orientation", "spacing", "size", "wrapperProps", "offset"]);
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: [],
...
var useStyles$m = createStyles((theme, { size: size2, radius, color, labelPosition, error }) => {
  ...
  return {
    ...
    track: __spreadProps$k(__spreadValues$C({}, theme.fn.focusStyles("input:focus + &")), {
...
const Switch = react.exports.forwardRef((props, ref) => {
  ...
  const _a = useComponentDefaultProps("Switch", defaultProps$a, props), {
    ...
    error,
    disabled
  } = _a, others = __objRest$o(_a, ["className", "color", "label", "offLabel", "onLabel", "id", "style", "size", "radius", "wrapperProps", "children", "unstyled", "styles", "classNames", "thumbIcon", "sx", "checked", "defaultChecked", "onChange", "labelPosition", "description", "error", "disabled"]);
  ...
  return /* @__PURE__ */ jsxs(InlineInput, {
    ...
    children: [/* @__PURE__ */ jsx("input", {
      ...__spreadProps$j(__spreadValues$B({}, rest), {
        disabled,
        checked: _checked,
        onChange: (event) => {
...
const Table = react.exports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...__spreadProps$h(__spreadValues$z({}, others), {
      component: "table",
      ref,
      className: cx(classes.root, className),
...
var useStyles$i = createStyles((theme, { color, size: size2, radius, gradient, variant }) => {
  ...
  return {
    root: __spreadProps$g(__spreadValues$y({}, theme.fn.fontStyles()), {
      display: "inline-flex",
      alignItems: "center",
      justifyContent: "center",
      boxSizing: "border-box",
...
function getNotificationStateStyles({
  ...
  return __spreadValues$w(__spreadValues$w({}, commonStyles), transitionStyles[state]);
}
...
function NotificationContainer(_a) {
  var _b = _a, {
    ...
    onHide,
    innerRef
  } = _b, others = __objRest$l(_b, ["notification", "autoClose", "onHide", "innerRef"]);
  const _a2 = notification, {
    autoClose: notificationAutoClose,
    message
  } = _a2, notificationProps = __objRest$l(_a2, ["autoClose", "message"]);
  ...
  return /* @__PURE__ */ jsx(Notification, {
    ...__spreadProps$f(__spreadValues$v(__spreadValues$v({}, notificationProps), others), {
      onClose: handleHide,
...
function useNotificationsState({ limit }) {
  ...
  const showNotification2 = (notification) => {
    ...
    update((notifications) => {
      ...
      return [...notifications, __spreadProps$e(__spreadValues$u({}, notification), { id })];
    });
    return id;
  };
...
function NotificationsProvider(_a) {
  var _b = _a, {
    ...
    children,
    target
  } = _b, others = __objRest$k(_b, ["className", "position", "autoClose", "transitionDuration", "containerWidth", "notificationMaxHeight", "limit", "zIndex", "style", "children", "target"]);
  ...
  const items = notifications.map((notification) => /* @__PURE__ */ jsx(Transition$1, {
    ...
    children: (state) => /* @__PURE__ */ jsx(NotificationContainer, {
      ...
      autoClose,
      sx: [__spreadValues$t({}, getNotificationStateStyles({
        state,
        positioning,
        transitionDuration: duration,
...
var useStyles$a = createStyles((theme, { centered, maxWidth, topOffset, radius, zIndex }) => ({
  root: __spreadProps$d(__spreadValues$r({}, theme.fn.cover()), {
    position: "fixed",
    zIndex
  }),
  spotlight: {
  ...
  overlay: __spreadProps$d(__spreadValues$r({}, theme.fn.cover()), {
    position: "fixed"
  }),
  inner: {
    height: "100vh",
        ...
        children: /* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsxs(Paper, {
            ...
            children: [/* @__PURE__ */ jsx(TextInput, {
              ...__spreadProps$c(__spreadValues$q({
...
function prepareAction(action) {
  return __spreadProps$b(__spreadValues$p({}, action), { id: action.id || randomId() });
}
...
function SpotlightProvider(_a) {
  ...
  } = _b, others = __objRest$h(_b, ["actions", "children", "shortcut", "onSpotlightClose", "onSpotlightOpen", "onQueryChange", "cleanQueryOnClose", "transitionDuration", "disabled", "tagsToIgnore"]);
...
export {
  ...
  useColorScheme as a1,
  navigationData as a2,
  SpotlightProvider as a3,
  NotificationsProvider as a4,
  NavigationProgress as a5,
  ...
  useToggle as q,
  useInfinityScroll as r,
  successMsg as s,
  Badge as t,
  useQueryParams as u,
  ActionPopoverIcon as v,
  UserHooks as w,
  getStatusMessage as x,
  encodeQueryParams as y,
  Card as z
};
