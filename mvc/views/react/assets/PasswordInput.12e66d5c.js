import { c as createStyles, r as react, J as useComponentDefaultProps, b as jsx, T as Text, K as createPolymorphicComponent, O as sizes, d as useMantineTheme, R as useId, S as extractSystemStyles, U as useUncontrolled, A as ActionIcon, V as Input } from "./use-form.49166e2b.js";
...
const _Anchor = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Anchor", defaultProps$1, props), {
    component,
    className,
    unstyled
  } = _a, others = __objRest$1(_a, ["component", "className", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$3(null, {
