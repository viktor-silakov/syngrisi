...
function Check({
  ...
  const imageHeight = 200 * (parseInt(checksViewSize, 10) / 100);
  osIconMap(check.os);
  ...
  const src = `${config.baseUri}/snapshoots/${(_a = check.baselineId) == null ? void 0 : _a.filename}`;
      ...
      children: [/* @__PURE__ */ jsx(Paper, {
        ...
        children: /* @__PURE__ */ jsx("a", {
          ...
          children: /* @__PURE__ */ jsx(Image, {
            ...
            fit: "contain",
            width: "100%",
            height: checksViewMode === "bounded" ? imageHeight : "auto",
            withPlaceholder: true,
            alt: check.name,
            sx: {
              cursor: "pointer"
