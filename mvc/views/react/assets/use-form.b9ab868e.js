...
function attachFunctions(themeBase) {
  return __spreadProps$p(__spreadValues$S({}, themeBase), {
    fn: {
...
function GlobalStyles({
  ...
  return /* @__PURE__ */ jsx(Global, {
    styles: {
      ...
      body: __spreadProps$o(__spreadValues$R({}, theme.fn.fontStyles()), {
  ...
  return Object.keys(currentTheme).reduce((acc, key) => {
    if (key === "headings" && themeOverride.headings) {
      const sizes2 = themeOverride.headings.sizes ? Object.keys(currentTheme.headings.sizes).reduce((headingsAcc, h2) => {
        headingsAcc[h2] = __spreadValues$Q(__spreadValues$Q({}, currentTheme.headings.sizes[h2]), themeOverride.headings.sizes[h2]);
        return headingsAcc;
      }, {}) : currentTheme.headings.sizes;
      return __spreadProps$n(__spreadValues$Q({}, acc), {
        headings: __spreadProps$n(__spreadValues$Q(__spreadValues$Q({}, currentTheme.headings), themeOverride.headings), {
          sizes: sizes2
        })
      });
    }
    acc[key] = typeof themeOverride[key] === "object" ? __spreadValues$Q(__spreadValues$Q({}, currentTheme[key]), themeOverride[key]) : typeof themeOverride[key] === "number" || typeof themeOverride[key] === "boolean" || typeof themeOverride[key] === "function" ? themeOverride[key] : themeOverride[key] || currentTheme[key];
    return acc;
  }, {});
}
...
function useComponentDefaultProps(component, defaultProps2, props) {
  ...
  return __spreadValues$P(__spreadValues$P(__spreadValues$P({}, defaultProps2), contextProps), filterProps(props));
}
function MantineProvider({
  ...
  const mergedTheme = mergeThemeWithFunctions(DEFAULT_THEME, inherit ? __spreadValues$P(__spreadValues$P({}, ctx.theme), theme) : theme);
...
function extractSystemStyles(others) {
  const _a = others, { m: m2, mx, my, mt, mb: mb2, ml: ml2, mr, p: p2, px, py, pt, pb: pb2, pl: pl2, pr } = _a, rest = __objRest$y(_a, ["m", "mx", "my", "mt", "mb", "ml", "mr", "p", "px", "py", "pt", "pb", "pl", "pr"]);
...
function getRef(args) {
  ...
  const argCopy = __spreadValues$O({}, arg);
  ...
  if (Array.isArray(styles2)) {
    return styles2.map((item) => extractStyles(item.styles)).reduce((acc, item) => {
      Object.keys(item).forEach((key) => {
        if (!acc[key]) {
          acc[key] = __spreadValues$N({}, item[key]);
        } else {
          acc[key] = __spreadValues$N(__spreadValues$N({}, acc[key]), item[key]);
        }
      });
      return acc;
    }, {});
...
const transitions = {
  ...
  pop: __spreadProps$m(__spreadValues$M({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps$m(__spreadValues$M({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps$m(__spreadValues$M({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps$m(__spreadValues$M({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps$m(__spreadValues$M({}, popIn), {
...
function parseHotkey(hotkey) {
  ...
  return __spreadProps$l(__spreadValues$L({}, modifiers), {
    key: freeKey
  });
}
...
const _Box = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    style,
    sx
  } = _b, others = __objRest$x(_b, ["className", "component", "style", "sx"]);
  const {
    systemStyles,
    rest
...
var useStyles$E = createStyles((theme) => ({
  root: __spreadProps$k(__spreadValues$J(__spreadValues$J({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    cursor: "pointer",
    border: 0,
    padding: 0,
    appearance: "none",
...
const _UnstyledButton = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("UnstyledButton", {}, props), {
    ...
    component = "button",
    unstyled
  } = _a, others = __objRest$w(_a, ["className", "component", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$F(null, {
...
var useStyles$C = createStyles((theme, { color, size: size2, radius: radius2, variant: variant2, gradient: gradient2 }) => ({
  root: __spreadProps$j(__spreadValues$H({}, getVariantStyles$2({ variant: variant2, theme, color, gradient: gradient2 })), {
    position: "relative",
...
function Oval(_a) {
  var _b = _a, {
    size: size2,
    color
  } = _b, others = __objRest$u(_b, ["size", "color"]);
...
function Loader(props) {
  const _a = useComponentDefaultProps("Loader", defaultProps$k, props), {
    size: size2,
    color,
    variant: variant2
  } = _a, others = __objRest$s(_a, ["size", "color", "variant"]);
  const theme = useMantineTheme();
...
const _ActionIcon = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ActionIcon", defaultProps$j, props), {
    className,
    color,
    children,
    radius: radius2,
    ...
    loading,
    unstyled
  } = _a, others = __objRest$r(_a, ["className", "color", "children", "radius", "size", "variant", "gradient", "disabled", "loaderProps", "loading", "unstyled"]);
  const {
    classes,
    cx,
    theme
...
function OptionalPortal(_a) {
  var _b = _a, {
    withinPortal = true,
    children
  } = _b, others = __objRest$q(_b, ["withinPortal", "children"]);
  if (withinPortal) {
...
var useStyles$A = createStyles((theme, {
  ...
  return {
    root: __spreadValues$A(__spreadProps$i(__spreadValues$A(__spreadValues$A(__spreadValues$A({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
const _Text = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Text", defaultProps$i, props), {
    className,
    size: size2,
    weight,
    transform,
    ...
    unstyled,
    span
  } = _a, others = __objRest$p(_a, ["className", "size", "weight", "transform", "color", "align", "variant", "lineClamp", "gradient", "inline", "inherit", "underline", "strikethrough", "italic", "classNames", "styles", "unstyled", "span"]);
  const {
    classes,
    cx
  } = useStyles$B({
...
const _Anchor = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Anchor", defaultProps$h, props), {
    component,
    className,
    unstyled
  } = _a, others = __objRest$o(_a, ["component", "className", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$z(null, {
...
function getTransitionStyles({
  ...
  if (typeof transition === "string") {
    ...
    return __spreadValues$x(__spreadValues$x(__spreadValues$x({
...
function getArrowPositionStyles({
  ...
  if (side === "left") {
    return __spreadProps$h(__spreadValues$w(__spreadValues$w({}, baseStyles), horizontalSide(placement, arrowY, arrowOffset)), {
      right: arrowPosition,
      borderLeft: 0,
      borderBottom: 0
    });
  ...
  if (side === "top") {
    return __spreadProps$h(__spreadValues$w(__spreadValues$w({}, baseStyles), verticalSide(placement, arrowX, arrowOffset, dir)), {
...
const FloatingArrow = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    arrowX,
    arrowY
  } = _b, others = __objRest$n(_b, ["withBorder", "position", "arrowSize", "arrowOffset", "visible", "arrowX", "arrowY"]);
  const theme = useMantineTheme();
  if (!visible) {
    return null;
  }
  return /* @__PURE__ */ jsx("div", {
    ...__spreadProps$g(__spreadValues$v({}, others), {
      ref,
...
function useInputProps(component, defaultProps2, props) {
  ...
  return __spreadProps$f(__spreadValues$u({}, rest), {
    classNames,
    styles: styles2,
    unstyled,
    wrapperProps: __spreadValues$u(__spreadValues$u({
      label,
      description,
      error,
      required,
...
const InputLabel = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    htmlFor,
    __staticSelector
  } = _b, others = __objRest$l(_b, ["labelElement", "children", "required", "size", "classNames", "styles", "unstyled", "className", "htmlFor", "__staticSelector"]);
  const {
    classes,
    cx
  } = useStyles$x({
...
const InputError = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    size: size2 = "sm",
    __staticSelector
  } = _b, others = __objRest$k(_b, ["children", "className", "classNames", "styles", "unstyled", "size", "__staticSelector"]);
  const {
    classes,
    cx
  } = useStyles$v({
...
const InputDescription = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    size: size2 = "sm",
    __staticSelector
  } = _b, others = __objRest$j(_b, ["children", "className", "classNames", "styles", "unstyled", "size", "__staticSelector"]);
  const {
    classes,
    cx
  } = useStyles$t({
...
var useStyles$q = createStyles((theme) => ({
  root: __spreadProps$e(__spreadValues$q({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight
  })
}));
...
const InputWrapper = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("InputWrapper", defaultProps$g, props), {
    className,
    label,
    children,
    required,
    ...
    inputWrapperOrder,
    withAsterisk
  } = _a, others = __objRest$i(_a, ["className", "label", "children", "required", "id", "error", "description", "labelElement", "labelProps", "descriptionProps", "errorProps", "classNames", "styles", "size", "inputContainer", "__staticSelector", "unstyled", "inputWrapperOrder", "withAsterisk"]);
  const {
    classes,
    cx
  } = useStyles$r(null, {
  ...
  const _description = description && /* @__PURE__ */ jsx(InputDescription, {
    ...__spreadProps$d(__spreadValues$p(__spreadValues$p({
      key: "description"
  ...
  const _error = typeof error !== "boolean" && error && /* @__PURE__ */ jsx(InputError, {
    ...__spreadProps$d(__spreadValues$p(__spreadValues$p({}, errorProps), sharedProps), {
...
var useStyles$o = createStyles((theme, {
  ...
  return {
    ...
    input: __spreadValues$o(__spreadProps$c(__spreadValues$o(__spreadProps$c(__spreadValues$o({}, theme.fn.fontStyles()), {
...
const _Input = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Input", defaultProps$f, props), {
    ...
    unstyled,
    pointer
  } = _a, others = __objRest$h(_a, ["className", "invalid", "required", "disabled", "variant", "icon", "style", "rightSectionWidth", "iconWidth", "rightSection", "rightSectionProps", "radius", "size", "wrapperProps", "classNames", "styles", "__staticSelector", "multiline", "sx", "unstyled", "pointer"]);
  const {
    offsetBottom,
    offsetTop
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [icon && /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$b(__spreadValues$n({
        component: "input"
      }, rest), {
        ref,
        required,
      ...
      ...__spreadProps$b(__spreadValues$n({}, rightSectionProps), {
...
var useStyles$m = createStyles((_theme, { orientation, buttonBorderWidth }) => ({
  root: {
    display: "flex",
...
const ButtonGroup = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ButtonGroup", defaultProps$e, props), {
    ...
    buttonBorderWidth,
    unstyled
  } = _a, others = __objRest$g(_a, ["className", "orientation", "buttonBorderWidth", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$n({
...
function getSizeStyles({ compact, size: size2, withLeftIcon, withRightIcon }) {
  ...
  return __spreadProps$a(__spreadValues$l({}, _sizes), {
...
var useStyles$k = createStyles((theme, {
  ...
  root: __spreadProps$a(__spreadValues$l(__spreadProps$a(__spreadValues$l(__spreadValues$l(__spreadValues$l(__spreadValues$l({}, getSizeStyles({ compact, size: size2, withLeftIcon, withRightIcon })), theme.fn.fontStyles()), theme.fn.focusStyles()), getWidthStyles(fullWidth)), {
    borderRadius: theme.fn.radius(radius2),
    fontWeight: 600,
    position: "relative",
    lineHeight: 1,
...
const _Button = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Button", defaultProps$d, props), {
    ...
    styles: styles2,
    unstyled
  } = _a, others = __objRest$f(_a, ["className", "size", "color", "type", "disabled", "children", "leftIcon", "rightIcon", "fullWidth", "variant", "radius", "uppercase", "compact", "loading", "loaderPosition", "loaderProps", "gradient", "classNames", "styles", "unstyled"]);
  const {
    classes,
    cx,
    theme
...
var useStyles$i = createStyles((theme, { radius: radius2, shadow, withBorder }) => ({
  root: {
    outline: 0,
    WebkitTapHighlightColor: "transparent",
    display: "block",
...
const _Paper = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Paper", defaultProps$c, props), {
    ...
    shadow,
    unstyled
  } = _a, others = __objRest$e(_a, ["className", "children", "radius", "withBorder", "shadow", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$j({
...
const _Center = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Center", {}, props), {
    inline: inline2,
    sx
  } = _a, others = __objRest$d(_a, ["inline", "sx"]);
  return /* @__PURE__ */ jsx(Box, {
    ...__spreadValues$i({
      ref,
      sx: [{
...
var useStyles$g = createStyles((theme, { spacing, position: position2, noWrap, grow, align, count: count2 }) => ({
  root: {
    boxSizing: "border-box",
    display: "flex",
    flexDirection: "row",
...
const Group = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Group", defaultProps$b, props), {
    ...
    spacing,
    unstyled
  } = _a, others = __objRest$b(_a, ["className", "position", "align", "children", "noWrap", "grow", "spacing", "unstyled"]);
...
var useStyles$e = createStyles((theme, { spacing, align, justify }) => ({
  root: {
    display: "flex",
...
const Stack = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Stack", defaultProps$a, props), {
    ...
    justify,
    unstyled
  } = _a, others = __objRest$a(_a, ["spacing", "className", "align", "justify", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$f({
...
const CheckboxGroup = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("CheckboxGroup", defaultProps$9, props), {
    ...
    wrapperProps,
    offset: offset2
  } = _a, others = __objRest$9(_a, ["children", "value", "defaultValue", "onChange", "orientation", "spacing", "size", "wrapperProps", "offset"]);
...
var useStyles$c = createStyles((theme, {
  ...
  return {
    ...
    labelWrapper: __spreadProps$9(__spreadValues$d({}, theme.fn.fontStyles()), {
      WebkitTapHighlightColor: "transparent",
      fontSize: theme.fn.size({ size: size2, sizes: theme.fontSizes }),
      lineHeight: `${_size}px`,
      color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    ...
    input: __spreadProps$9(__spreadValues$d({}, theme.fn.focusStyles()), {
      appearance: "none",
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[6] : theme.white,
...
var oy = ["size", "color", "stroke"];
function ry(r2) {
  var n2 = r2.size, l2 = void 0 === n2 ? 24 : n2, i = r2.color, a = void 0 === i ? "currentColor" : i, c2 = r2.stroke, s = void 0 === c2 ? 2 : c2, h2 = o(r2, oy);
  return react.exports.createElement("svg", t({ xmlns: "http://www.w3.org/2000/svg", className: "icon icon-tabler icon-tabler-caret-left", width: l2, height: l2, viewBox: "0 0 24 24", strokeWidth: s, stroke: a, fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }, h2), react.exports.createElement("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }), react.exports.createElement("path", { d: "M14 6l-6 6l6 6v-12" }));
}
var ny = ["size", "color", "stroke"];
function ly(r2) {
  var n2 = r2.size, l2 = void 0 === n2 ? 24 : n2, i = r2.color, a = void 0 === i ? "currentColor" : i, c2 = r2.stroke, s = void 0 === c2 ? 2 : c2, h2 = o(r2, ny);
  return react.exports.createElement("svg", t({ xmlns: "http://www.w3.org/2000/svg", className: "icon icon-tabler icon-tabler-caret-right", width: l2, height: l2, viewBox: "0 0 24 24", strokeWidth: s, stroke: a, fill: "none", strokeLinecap: "round", strokeLinejoin: "round" }, h2), react.exports.createElement("path", { stroke: "none", d: "M0 0h24v24H0z", fill: "none" }), react.exports.createElement("path", { d: "M10 18l6 -6l-6 -6v12" }));
}
...
const devices$1 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: devices
...
const customDevices = useQuery(
  ["custom_devices"],
  () => ky$1(`${baseUrl}/static/data/custom_devices.json`).json(),
  {
    cacheTime: 60 * 60 * 10,
    staleTime: 60 * 60 * 10,
    enabled: true,
...
const config = {
  baseUri: baseUrl || "",
  devices: devices$1,
  customDevicesProm: customDevices.data
};
var queryString = {};
