...
function useCollapse({
  ...
  const mergeStyles = (newStyles) => {
    setStyles((oldStyles) => __spreadValues$1u(__spreadValues$1u({}, oldStyles), newStyles));
  };
    ...
    if (opened) {
      raf(() => {
        ...
        raf(() => {
          ...
          mergeStyles(__spreadProps$G(__spreadValues$1u({}, getTransitionStyles2(height)), { height }));
        });
      });
    } else {
      raf(() => {
        const height = getElementHeight(el);
        mergeStyles(__spreadProps$G(__spreadValues$1u({}, getTransitionStyles2(height)), { willChange: "height", height }));
  ...
  function getCollapseProps(_a = {}) {
    ...
    return __spreadProps$G(__spreadValues$1u({
      "aria-hidden": !opened
    }, rest), {
      [refKey]: mergeRefs(el, theirRef),
      onTransitionEnd: handleTransitionEnd,
      style: __spreadValues$1u(__spreadValues$1u({ boxSizing: "border-box" }, style), styles)
    });
  }
...
const Collapse = react.exports.forwardRef((props, ref) => {
  ...
  if (duration === 0) {
    return opened ? /* @__PURE__ */ jsx(Box, {
      ...__spreadValues$1t({}, rest),
      children
    }) : null;
  }
  return /* @__PURE__ */ jsx(Box, {
    ...__spreadValues$1t({}, getCollapseProps(__spreadValues$1t(__spreadValues$1t({
      style,
      ref
    }, rest), systemStyles))),
...
const Affix = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Affix", defaultProps$v, props), {
    target,
    position,
    zIndex,
    sx,
...
const CloseButton = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("CloseButton", defaultProps$u, props), {
    iconSize,
    size: size2 = "md"
...
var useStyles$18 = createStyles((theme, {
  ...
  return {
    root: __spreadProps$F(__spreadValues$1p(__spreadValues$1p(__spreadProps$F(__spreadValues$1p(__spreadValues$1p({}, theme.fn.fontStyles()), position), {
...
const Navbar = react.exports.forwardRef((props, ref) => {
  const _props = useComponentDefaultProps("Navbar", defaultProps$t, props);
...
var useStyles$16 = createStyles((theme, { height, fixed, position, zIndex, borderPosition }) => ({
  root: __spreadProps$E(__spreadValues$1l(__spreadValues$1l({}, theme.fn.fontStyles()), position), {
    zIndex,
    height,
    maxHeight: height,
    position: fixed ? "fixed" : "static",
...
const Header = react.exports.forwardRef((props, ref) => {
  const _props = useComponentDefaultProps("Header", defaultProps$s, props);
  return /* @__PURE__ */ jsx(VerticalSection, {
    ...__spreadProps$D(__spreadValues$1j({
      section: "header",
...
var useStyles$14 = createStyles((theme, props) => ({
  root: {
    boxSizing: "border-box"
  },
  body: {
...
const AppShell = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("AppShell", defaultProps$r, props), {
    children,
    navbar,
    header,
    footer,
    ...
    classNames,
    unstyled
  } = _a, others = __objRest$V(_a, ["children", "navbar", "header", "footer", "aside", "fixed", "zIndex", "padding", "navbarOffsetBreakpoint", "asideOffsetBreakpoint", "className", "styles", "classNames", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$15({
...
var useStyles$12 = createStyles((theme, { size: size2, variant, color }) => ({
  root: {},
  withLabel: {
  ...
  label: {
    ...
    "&::before": {
      ...
      flex: 1,
      height: 1,
      borderTop: `${theme.fn.size({ size: size2, sizes: sizes$9 })}px ${variant} ${getColor(theme, color)}`,
  ...
  horizontal: {
    border: 0,
    borderTopWidth: theme.fn.size({ size: size2, sizes: sizes$9 }),
  ...
  vertical: {
    ...
    alignSelf: "stretch",
    height: "auto",
    borderLeftWidth: theme.fn.size({ size: size2, sizes: sizes$9 }),
...
const Divider = react.exports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: withLabel && /* @__PURE__ */ jsx(Text, {
      ...__spreadProps$C(__spreadValues$1g({}, labelProps), {
...
var useStyles$10 = createStyles((theme, { size: size2 }) => ({
  item: {
    boxSizing: "border-box",
    textAlign: "left",
    width: "100%",
    ...
    "&[data-selected]": __spreadValues$1f({
...
var useStyles$_ = createStyles((theme, { scrollbarSize, offsetScrollbars, scrollbarHovered, hidden: hidden2 }, getRef) => ({
  root: {
    overflow: "hidden"
  },
  viewport: {
...
const _ScrollArea = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ScrollArea", defaultProps$p, props), {
    children,
    className,
    classNames,
    styles,
...
const ScrollAreaAutosize = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ScrollAreaAutosize", defaultProps$p, props), {
    maxHeight,
    children,
    classNames,
    styles,
  ...
  return /* @__PURE__ */ React.createElement(Box, __spreadProps$B(__spreadValues$1c({}, others), {
    ref,
    sx: [{
      display: "flex",
      maxHeight
...
const PopoverTarget = react.exports.forwardRef((_a, ref) => {
  var _b = _a, { children, refProp = "ref", popupType = "dialog" } = _b, others = __objRest$Q(_b, ["children", "refProp", "popupType"]);
  ...
  return react.exports.cloneElement(children, __spreadValues$1a(__spreadProps$z(__spreadValues$1a(__spreadValues$1a(__spreadValues$1a({}, forwardedProps), accessibleProps), ctx.targetProps), {
    className: clsx(ctx.targetProps.className, forwardedProps.className, children.props.className),
    [refProp]: targetRef
  }), !ctx.controlled ? { onClick: ctx.onToggle } : null));
});
PopoverTarget.displayName = "@mantine/core/PopoverTarget";
var useStyles$W = createStyles((theme, { radius, shadow }) => ({
  dropdown: {
    position: "absolute",
...
function PopoverDropdown(_a) {
  var _b = _a, {
    ...
    className,
    children
  } = _b, others = __objRest$P(_b, ["style", "className", "children"]);
  const {
    classNames,
    styles,
    unstyled,
    ...
    children: /* @__PURE__ */ jsx(Transition$2, {
      ...
      children: (transitionStyles) => {
        ...
        return /* @__PURE__ */ jsx(FocusTrap, {
          ...
          children: /* @__PURE__ */ jsxs(Box, {
            ...__spreadValues$19(__spreadProps$y(__spreadValues$19({}, accessibleProps), {
              tabIndex: -1,
              ref: ctx.floating,
              style: __spreadProps$y(__spreadValues$19(__spreadValues$19({}, style), transitionStyles), {
                zIndex: ctx.zIndex,
...
function Popover(props) {
  const _a = useComponentDefaultProps("Popover", defaultProps$o, props), {
    children,
    position,
    offset: offset2,
    onPositionChange,
...
function AvatarPlaceholderIcon(props) {
  return /* @__PURE__ */ jsx("svg", {
    ...__spreadProps$x(__spreadValues$17({}, props), {
      width: "15",
      height: "15",
      viewBox: "0 0 15 15",
      fill: "none",
...
function useAvatarGroupContext() {
  ...
  if (ctx) {
    return __spreadProps$w(__spreadValues$16({}, ctx), {
      withinGroup: true
    });
  }
  return {
...
var useStyles$U = createStyles((theme, { spacing }) => ({
  root: {
    display: "flex",
...
const AvatarGroup = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("AvatarGroup", defaultProps$n, props), {
    children,
    spacing = "sm",
    unstyled,
    className
...
var useStyles$S = createStyles((theme, { size: size2, radius, color, withinGroup, spacing, variant, gradient }) => {
  const colors = theme.fn.variant({ variant, color, gradient });
  return {
    root: __spreadValues$14(__spreadProps$v(__spreadValues$14({}, theme.fn.focusStyles()), {
    ...
    placeholder: __spreadProps$v(__spreadValues$14({}, theme.fn.fontStyles()), {
      fontSize: theme.fn.size({ size: size2, sizes: sizes$8 }) / 2.5,
      color: colors.color,
      fontWeight: 700,
...
const _Avatar = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Avatar", defaultProps$m, props), {
    className,
    size: size2,
    src,
    alt,
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: error ? /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$u(__spreadValues$13({}, imageProps), {
...
var useStyles$Q = createStyles((theme, { color, size: size2, radius, gradient, fullWidth, variant }) => {
  const { fontSize, height } = size2 in sizes$7 ? sizes$7[size2] : sizes$7.md;
  return {
    leftSection: {
    ...
    root: __spreadValues$12(__spreadProps$t(__spreadValues$12(__spreadValues$12({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
      fontSize,
      height,
      WebkitTapHighlightColor: "transparent",
...
const _Badge = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Badge", defaultProps$l, props), {
    className,
    color,
    variant,
    fullWidth,
...
const Breadcrumbs = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Breadcrumbs", defaultProps$k, props), {
    className,
    children,
    separator,
    classNames,
...
var useStyles$M = createStyles((theme, { size: size2, color, transitionDuration }) => {
  const sizeValue = theme.fn.size({ size: size2, sizes: sizes$6 });
...
const Burger = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Burger", defaultProps$j, props), {
    className,
    opened,
    color,
    size: size2,
...
function ChipGroup(props) {
  const _a = useComponentDefaultProps("ChipGroup", defaultProps$i, props), {
    value,
    defaultValue,
    onChange,
    spacing,
...
var useStyles$K = createStyles((theme, { radius, size: size2, color }, getRef) => ({
  root: {},
  label: __spreadProps$s(__spreadValues$Z({
    ref: getRef("label")
  }, theme.fn.fontStyles()), {
    boxSizing: "border-box",
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    ...
    fontSize: theme.fn.size({ size: size2, sizes: theme.fontSizes }),
    lineHeight: `${theme.fn.size({ size: size2, sizes: sizes$5 }) - 2}px`,
    ...
    WebkitTapHighlightColor: "transparent",
    '&[data-variant="filled"]': __spreadValues$Z({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[4] : theme.colors.gray[1]
    }, theme.fn.hover({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.colors.gray[0]
    })),
    '&[data-variant="outline"]': __spreadValues$Z({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[6] : theme.white,
      borderColor: theme.colorScheme === "dark" ? theme.colors.dark[4] : theme.colors.gray[4]
    }, theme.fn.hover({
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[5] : theme.colors.gray[0]
    })),
    "&[data-disabled]": __spreadProps$s(__spreadValues$Z({
...
const Chip = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Chip", defaultProps$h, props), {
    radius,
    type,
    size: size2,
    variant,
...
var useStyles$I = createStyles((theme, { color }) => ({
  root: {
...
const Mark = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Mark", defaultProps$g, props), {
    color,
    className,
    unstyled
  } = _a, others = __objRest$F(_a, ["color", "className", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$J({
...
const _Highlight = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Highlight", defaultProps$f, props), {
    children,
    highlight,
    highlightColor,
    highlightStyles,
    unstyled
  } = _a, others = __objRest$E(_a, ["children", "highlight", "highlightColor", "highlightStyles", "unstyled"]);
...
const Kbd = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Kbd", {}, props), {
    ...
    children,
    unstyled
  } = _a, others = __objRest$D(_a, ["className", "children", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$H(null, {
...
var useStyles$E = createStyles((theme, { spacing, center }, getRef) => ({
  itemWrapper: {
...
function ListItem(_a) {
  var _b = _a, {
    ...
    children,
    icon
  } = _b, others = __objRest$C(_b, ["className", "children", "icon"]);
  const {
    icon: ctxIcon,
    spacing,
    center
...
var useStyles$C = createStyles((theme, { withPadding, size: size2, listStyleType }) => ({
  root: __spreadProps$r(__spreadValues$T({}, theme.fn.fontStyles()), {
    listStyleType,
    color: theme.colorScheme === "dark" ? theme.colors.dark[0] : theme.black,
    fontSize: theme.fn.size({ size: size2, sizes: theme.fontSizes }),
    lineHeight: theme.lineHeight,
...
const List = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("List", defaultProps$e, props), {
    children,
    type,
    size: size2,
    listStyleType,
    ...
    classNames,
    unstyled
  } = _a, others = __objRest$B(_a, ["children", "type", "size", "listStyleType", "withPadding", "center", "spacing", "icon", "className", "styles", "classNames", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$D({
...
function MenuDivider(_a) {
  var _b = _a, {
    children,
    className
  } = _b, others = __objRest$A(_b, ["children", "className"]);
  const {
    classNames,
    styles,
    unstyled
...
var useStyles$y = createStyles((theme, { color, radius }) => ({
  item: __spreadProps$q(__spreadValues$P({}, theme.fn.fontStyles()), {
    WebkitTapHighlightColor: "transparent",
...
const _MenuItem = react.exports.forwardRef((_a, ref) => {
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...__spreadProps$p(__spreadValues$O({
      component: "button"
    }, others), {
      type: "button",
      tabIndex: -1,
...
function Menu(props) {
  ...
  return /* @__PURE__ */ jsx(MenuContextProvider, {
    ...
    children: /* @__PURE__ */ jsx(Popover, {
      ...__spreadProps$o(__spreadValues$L({}, others), {
        radius,
        opened: _opened,
        onChange: setOpened,
        defaultOpened,
...
var useStyles$s = createStyles((theme, { overflow, size: size2, centered, zIndex, fullScreen }) => ({
  close: {},
  overlay: {
  ...
  modal: __spreadValues$K({
    position: "relative",
    width: fullScreen ? void 0 : theme.fn.size({ sizes: sizes$4, size: size2 }),
...
function ChevronIcon(_a) {
  var _b = _a, {
    ...
    error,
    style
  } = _b, others = __objRest$t(_b, ["size", "error", "style"]);
  const theme = useMantineTheme();
...
function getSelectRightSectionProps(_a) {
  var _b = _a, {
    ...
    rightSectionWidth,
    theme
  } = _b, props = __objRest$s(_b, ["styles", "rightSection", "rightSectionWidth", "theme"]);
  if (rightSection) {
    return {
      rightSection,
      rightSectionWidth,
  ...
  return {
    ...
    rightSection: !props.readOnly && !(props.disabled && props.shouldClear) && /* @__PURE__ */ jsx(SelectRightSection, {
      ...__spreadValues$H({}, props)
    }),
    styles: __spreadProps$n(__spreadValues$H({}, _styles), {
      rightSection: __spreadProps$n(__spreadValues$H({}, _styles == null ? void 0 : _styles.rightSection), {
        pointerEvents: props.shouldClear ? void 0 : "none"
      })
    })
  };
}
var useStyles$q = createStyles((theme, { color, radius, withTitle }, getRef) => {
...
const Notification = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Notification", {}, props), {
    ...
    styles,
    unstyled
  } = _a, others = __objRest$r(_a, ["className", "color", "radius", "loading", "disallowClose", "title", "icon", "children", "onClose", "closeButtonProps", "classNames", "styles", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$r({
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [icon && !loading && /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$m(__spreadValues$G({}, closeButtonProps), {
        iconSize: 16,
        color: "gray",
        onClick: onClose,
...
function getCurves({ size: size2, thickness, sections, renderRoundedLineCaps }) {
  ...
  curvesInOrder.push(__spreadProps$l(__spreadValues$E({}, curves[curves.length - 1]), { lineRoundCaps: false }));
  if (curves.length > 2) {
    curvesInOrder.push(__spreadProps$l(__spreadValues$E({}, curves[0]), { lineRoundCaps: renderRoundedLineCaps }));
    curvesInOrder.push(__spreadProps$l(__spreadValues$E({}, curves[curves.length - 2]), { lineRoundCaps: renderRoundedLineCaps }));
    for (let i = 1; i <= curves.length - 3; i += 1) {
      curvesInOrder.push(__spreadProps$l(__spreadValues$E({}, curves[i]), { lineRoundCaps: false }));
    }
  } else {
    curvesInOrder.push(__spreadProps$l(__spreadValues$E({}, curves[0]), { lineRoundCaps: renderRoundedLineCaps }));
  }
...
var useStyles$i = createStyles((theme, { captionSide, horizontalSpacing, verticalSpacing, fontSize }) => ({
...
const Table = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Table", defaultProps$8, props), {
    ...
    fontSize,
    unstyled
  } = _a, others = __objRest$n(_a, ["className", "children", "striped", "highlightOnHover", "captionSide", "horizontalSpacing", "verticalSpacing", "fontSize", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$j({
...
function useInfinityScroll({
  ...
  const firstPageQuery = useQuery([
    ...
    resourceName
  ], () => GenericService.get(resourceName, baseFilterObj, {
    page: "1",
    limit: "1"
  }, "firstPageQuery"), {
    enabled: false,
...
var useStyles$1 = createStyles((theme, { size: size2 }) => ({
  ...
  controls: {
    display: "flex",
    alignItems: "center",
    height: theme.fn.size({ size: size2, sizes: sizes$a }) - 2
  }
}));
...
export {
  ...
  GroupedTransition as ac,
  createEventHandler as ad,
  useDelayedHover as ae,
  _objectWithoutPropertiesLoose as af,
  useScrollIntoView as ag,
  groupOptions$1 as ah,
  getSelectRightSectionProps as ai,
  Divider as aj,
  Avatar as ak,
  Highlight as al,
  Mark as am,
