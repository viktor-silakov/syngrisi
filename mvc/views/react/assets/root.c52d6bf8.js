import { r as react, Y as useWindowEvent, Z as queryString, d as useMantineTheme, b as jsx, y as useLocalStorage, u as useQuery, j as jsxs, e as Container, G as Group, T as Text, g as Button, _ as Dge, P as Paper, c as createStyles, q as Checkbox, $ as Stack, a0 as Tooltip, L as Transition, s as ActionIcon, a1 as Xfe, a2 as rze, p as TextInput, m as lAe, O as Loader, a3 as zV, a4 as ea, A as Anchor, a5 as Fragment, a6 as Epe, a7 as Ol, a8 as ua, a9 as RX, aa as React, k as ky, a as config, l as log, ab as rWe, B as Box, n as useSearchParams, ac as Y, Q as QueryClient, f as useDocumentTitle, ad as useNavigate, E as QueryClientProvider, F as ColorSchemeProvider, M as MantineProvider, ae as Routes, af as Route, H as createRoot, I as BrowserRouter } from "./use-form.214c851e.js";
import { u as useQueryParams, S as StringParam, J as JsonParam, a as useColorScheme, b as useDisclosure, l as links, H as Header, B as Burger, c as HeaderLogo, d as SafeSelect, o as openSpotlight, K as Kbd, U as UserMenu, T as ToggleThemeButton, e as Breadcrumbs, f as errorMsg, G as GenericService, i as isDark, L as List, R as RingProgress, g as useInView, h as Skeleton, F as FocusTrap, j as escapeRegExp, k as useToggle, m as useInfinityScroll, N as Navbar, n as ScrollArea, p as getNavigationItem, s as stopNavigationProgress, r as resetNavigationProgress, q as Badge, A as Affix, t as useMutation, v as successMsg, w as ActionPopoverIcon, I as Image, C as Card, x as Collapse, M as Modal, y as Table, z as useInputState, D as RelativeDrawer, E as Chip, O as SegmentedControl, P as LogicalGroup, Q as uuid, V as useNavProgressFetchEffect, W as AppShell, X as ReactQueryDevtools, Y as navigationData, Z as SpotlightProvider, _ as NotificationsProvider, $ as NavigationProgress, a0 as ModalsProvider, a1 as QueryParamProvider, a2 as ReactRouter6Adapter } from "./LogicalGroup.fad774d3.js";
...
const ChecksService = {
  async acceptCheck({ check: check2, newBaselineId }) {
    try {
      const resp = await ky(`${config.baseUri}/acceptChecks/${check2._id}`, {
      ...
      throw new Error(`cannot accept check: '${JSON.stringify(check2, null, "/t")}',
...
function AcceptButton({
  ...
  const theme = useMantineTheme();
  const isAccepted = check2.markedAs === "accepted";
  const isCurrentlyAccepted = check2.baselineId._id === check2.actualSnapshotId._id && isAccepted;
  ...
  const handleAcceptCheckClick = () => {
    ...
    mutationAcceptCheck.mutate({
      check: check2,
      newBaselineId: check2.actualSnapshotId._id
    });
  };
...
function Check({
  ...
  osIconMap(check2.os);
  browserIconMap(check2.browserName);
  const theme = useMantineTheme();
  ...
  const src = `${config.baseUri}/snapshoots/${check2.baselineId.filename}`;
  return /* @__PURE__ */ jsx(Fragment, {
    children: checksViewMode === "list" ? /* @__PURE__ */ jsxs(Group, {
      ...
      children: [/* @__PURE__ */ jsx(Paper, {
        ...
        children: check2.name
      }), /* @__PURE__ */ jsxs(Group, {
        position: "right",
        children: [/* @__PURE__ */ jsx(Badge, {
          color: statusColor(check2.status),
          variant: "light",
          size: "md",
          title: "Check status",
          children: check2.status
        }), /* @__PURE__ */ jsx(Text, {
          color: "dimmed",
          weight: 500,
          size: 14,
          title: "Screen Viewport",
          children: check2.viewport
        }), /* @__PURE__ */ jsxs(Group, {
          spacing: 4,
          position: "left",
          noWrap: true,
...
function Checks({
  ...
  const checksQuery = useQuery(["checks", item._id], () => GenericService.get("checks", {
    _id: {
      $in: item.checks
    }
  }, {
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: checksQuery.isLoading ? /* @__PURE__ */ jsx(ChecksSkeleton, {}) : checksQuery.isError ? /* @__PURE__ */ jsx(Text, {
      ...
      p: 20,
      align: "start",
      children: checksQuery.data.results.map((check2) => /* @__PURE__ */ jsx(Check, {
        check: check2,
        checksViewMode,
        checksQuery,
        testUpdateQuery
