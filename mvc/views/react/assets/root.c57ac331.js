...
function ViewPortLabel({
  ...
  const theme = useMantineTheme();
  const wrongSizeIcon = check.failReasons.includes("not_accepted") ? /* @__PURE__ */ jsx(Badge, {
    component: "div",
    title: "Actual and Expected screenshot have different size",
    pl: 4,
    pr: 4,
    pt: 6,
    pb: 6,
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: /* @__PURE__ */ jsxs(Group, {
      children: [/* @__PURE__ */ jsxs(Text, {
        ...
        children: [wrongSizeIcon, "123", check.viewport]
      }), wrongSizeIcon]
    })
  });
}
