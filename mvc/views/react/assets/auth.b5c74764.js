...
function attachFunctions(themeBase) {
  return __spreadProps$k(__spreadValues$O({}, themeBase), {
    fn: {
...
function GlobalStyles({
  ...
  return /* @__PURE__ */ jsx(Global, {
    styles: {
      ...
      body: __spreadProps$j(__spreadValues$N({}, theme.fn.fontStyles()), {
...
function mergeTheme(currentTheme, themeOverride) {
  ...
  return Object.keys(currentTheme).reduce((acc, key) => {
    if (key === "headings" && themeOverride.headings) {
      ...
      return __spreadProps$i(__spreadValues$M({}, acc), {
        headings: __spreadProps$i(__spreadValues$M(__spreadValues$M({}, currentTheme.headings), themeOverride.headings), {
          sizes: sizes2
        })
      });
    }
...
function parseHotkey(hotkey) {
  ...
  return __spreadProps$h(__spreadValues$I({}, modifiers), {
    key: freeKey
  });
}
...
var useStyles$A = createStyles((theme) => ({
  root: __spreadProps$g(__spreadValues$G(__spreadValues$G({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    cursor: "pointer",
    border: 0,
    padding: 0,
    appearance: "none",
...
function useCollapse({
  ...
  const mergeStyles = (newStyles) => {
    setStyles((oldStyles) => __spreadValues$E(__spreadValues$E({}, oldStyles), newStyles));
  };
    ...
    if (opened) {
      raf(() => {
        ...
        raf(() => {
          ...
          mergeStyles(__spreadProps$f(__spreadValues$E({}, getTransitionStyles(height)), { height }));
        });
      });
    } else {
      raf(() => {
        const height = getElementHeight(el2);
        mergeStyles(__spreadProps$f(__spreadValues$E({}, getTransitionStyles(height)), { willChange: "height", height }));
  ...
  function getCollapseProps(_a = {}) {
    ...
    return __spreadProps$f(__spreadValues$E({
      "aria-hidden": !opened
    }, rest), {
      [refKey]: useMergedRef(el2, theirRef),
      onTransitionEnd: handleTransitionEnd,
      style: __spreadValues$E(__spreadValues$E({ boxSizing: "border-box" }, style), styles2)
    });
  }
...
const Collapse = react.exports.forwardRef((props, ref) => {
  ...
  if (duration === 0) {
    return opened ? /* @__PURE__ */ jsx(Box, {
      ...__spreadValues$D({}, rest),
      children
    }) : null;
  }
  return /* @__PURE__ */ jsx(Box, {
    ...__spreadValues$D({}, getCollapseProps(__spreadValues$D(__spreadValues$D({
      style,
      ref
    }, rest), systemStyles))),
...
var useStyles$y = createStyles((theme, { color, size: size2, radius: radius2, variant: variant2 }) => ({
  root: __spreadProps$e(__spreadValues$B({}, getVariantStyles$2({ variant: variant2, theme, color })), {
    position: "relative",
...
var useStyles$w = createStyles((theme, {
  ...
  return {
    root: __spreadValues$v(__spreadProps$d(__spreadValues$v(__spreadValues$v(__spreadValues$v({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
const _Anchor = react.exports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsx(Text, {
    ...__spreadValues$t(__spreadValues$t({
...
function useInputProps(component, defaultProps2, props) {
  ...
  return __spreadProps$c(__spreadValues$s({}, rest), {
    classNames,
    styles: styles2,
    unstyled,
    wrapperProps: __spreadValues$s(__spreadValues$s({
      label,
      description,
      error,
      required,
...
var useStyles$m = createStyles((theme) => ({
  root: __spreadProps$b(__spreadValues$o({}, theme.fn.fontStyles()), {
    lineHeight: theme.lineHeight
  })
}));
...
const InputWrapper = react.exports.forwardRef((props, ref) => {
  ...
  const _error = typeof error !== "boolean" && error && /* @__PURE__ */ jsx(InputError, {
    ...__spreadValues$n(__spreadProps$a(__spreadValues$n({}, errorProps), {
      key: "error"
    }), sharedProps),
    children: error
  });
...
var useStyles$k = createStyles((theme, {
  ...
  return {
    ...
    input: __spreadValues$m(__spreadProps$9(__spreadValues$m(__spreadProps$9(__spreadValues$m({}, theme.fn.fontStyles()), {
...
const _Input = react.exports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [icon && /* @__PURE__ */ jsx("div", {
      ...
      ...__spreadProps$8(__spreadValues$l({
        component: "input"
      }, rest), {
        ref,
        required,
      ...
      ...__spreadProps$8(__spreadValues$l({}, rightSectionProps), {
...
function getSizeStyles({ compact, size: size2, withLeftIcon, withRightIcon }) {
  ...
  return __spreadProps$7(__spreadValues$j({}, _sizes), {
...
var useStyles$g = createStyles((theme, {
  ...
  root: __spreadProps$7(__spreadValues$j(__spreadProps$7(__spreadValues$j(__spreadValues$j(__spreadValues$j(__spreadValues$j({}, getSizeStyles({ compact, size: size2, withLeftIcon, withRightIcon })), theme.fn.fontStyles()), theme.fn.focusStyles()), getWidthStyles(fullWidth)), {
    borderRadius: theme.fn.radius(radius2),
    fontWeight: 600,
    position: "relative",
    lineHeight: 1,
...
var useStyles$8 = createStyles((theme, { size: size2, radius: radius2, color, transitionDuration }, getRef2) => {
  ...
  return {
    ...
    label: __spreadProps$6(__spreadValues$b({}, theme.fn.fontStyles()), {
      WebkitTapHighlightColor: "transparent",
    ...
    input: __spreadProps$6(__spreadValues$b({}, theme.fn.focusStyles()), {
      appearance: "none",
      backgroundColor: theme.colorScheme === "dark" ? theme.colors.dark[6] : theme.white,
      border: `1px solid ${theme.colorScheme === "dark" ? theme.colors.dark[4] : theme.colors.gray[4]}`,
      width: _size,
...
var useStyles$4 = createStyles((theme, { color, variant: variant2, noWrap, childrenOffset, alignIcon }) => {
  ...
  return {
    root: __spreadProps$5(__spreadValues$8({
      display: "flex",
      alignItems: "center",
      width: "100%",
...
const TextInput = react.exports.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ jsx(Input.Wrapper, {
    ...
    children: /* @__PURE__ */ jsx(Input, {
      ...__spreadProps$4(__spreadValues$6(__spreadValues$6({}, inputProps), others), {
        ref
      })
    })
  });
