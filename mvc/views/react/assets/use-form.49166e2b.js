...
function attachFunctions(themeBase) {
  return __spreadProps$p(__spreadValues$R({}, themeBase), {
    fn: {
...
function GlobalStyles({
  ...
  return /* @__PURE__ */ jsx(Global, {
    styles: {
      ...
      body: __spreadProps$o(__spreadValues$Q({}, theme.fn.fontStyles()), {
  ...
  return Object.keys(currentTheme).reduce((acc, key) => {
    if (key === "headings" && themeOverride.headings) {
      const sizes2 = themeOverride.headings.sizes ? Object.keys(currentTheme.headings.sizes).reduce((headingsAcc, h2) => {
        headingsAcc[h2] = __spreadValues$P(__spreadValues$P({}, currentTheme.headings.sizes[h2]), themeOverride.headings.sizes[h2]);
        return headingsAcc;
      }, {}) : currentTheme.headings.sizes;
      return __spreadProps$n(__spreadValues$P({}, acc), {
        headings: __spreadProps$n(__spreadValues$P(__spreadValues$P({}, currentTheme.headings), themeOverride.headings), {
          sizes: sizes2
        })
      });
    }
    acc[key] = typeof themeOverride[key] === "object" ? __spreadValues$P(__spreadValues$P({}, currentTheme[key]), themeOverride[key]) : typeof themeOverride[key] === "number" || typeof themeOverride[key] === "boolean" || typeof themeOverride[key] === "function" ? themeOverride[key] : themeOverride[key] || currentTheme[key];
    return acc;
  }, {});
}
...
function useComponentDefaultProps(component, defaultProps2, props) {
  ...
  return __spreadValues$O(__spreadValues$O(__spreadValues$O({}, defaultProps2), contextProps), filterProps(props));
}
function MantineProvider({
  ...
  const mergedTheme = mergeThemeWithFunctions(DEFAULT_THEME, inherit ? __spreadValues$O(__spreadValues$O({}, ctx.theme), theme) : theme);
...
function extractSystemStyles(others) {
  const _a = others, { m: m2, mx, my, mt, mb: mb2, ml: ml2, mr, p: p2, px, py, pt, pb: pb2, pl: pl2, pr } = _a, rest = __objRest$x(_a, ["m", "mx", "my", "mt", "mb", "ml", "mr", "p", "px", "py", "pt", "pb", "pl", "pr"]);
...
function getRef(args) {
  ...
  const argCopy = __spreadValues$N({}, arg);
  ...
  if (Array.isArray(styles2)) {
    return styles2.map((item) => extractStyles(item.styles)).reduce((acc, item) => {
      Object.keys(item).forEach((key) => {
        if (!acc[key]) {
          acc[key] = __spreadValues$M({}, item[key]);
        } else {
          acc[key] = __spreadValues$M(__spreadValues$M({}, acc[key]), item[key]);
        }
      });
      return acc;
    }, {});
...
const transitions = {
  ...
  pop: __spreadProps$m(__spreadValues$L({}, popIn), {
    common: { transformOrigin: "center center" }
  }),
  "pop-bottom-left": __spreadProps$m(__spreadValues$L({}, popIn), {
    common: { transformOrigin: "bottom left" }
  }),
  "pop-bottom-right": __spreadProps$m(__spreadValues$L({}, popIn), {
    common: { transformOrigin: "bottom right" }
  }),
  "pop-top-left": __spreadProps$m(__spreadValues$L({}, popIn), {
    common: { transformOrigin: "top left" }
  }),
  "pop-top-right": __spreadProps$m(__spreadValues$L({}, popIn), {
...
function parseHotkey(hotkey) {
  ...
  return __spreadProps$l(__spreadValues$K({}, modifiers), {
    key: freeKey
  });
}
...
const _Box = react.exports.forwardRef((_a, ref) => {
  var _b = _a, {
    ...
    style,
    sx
  } = _b, others = __objRest$w(_b, ["className", "component", "style", "sx"]);
  const {
    systemStyles,
    rest
...
var useStyles$C = createStyles((theme) => ({
  root: __spreadProps$k(__spreadValues$I(__spreadValues$I({}, theme.fn.focusStyles()), theme.fn.fontStyles()), {
    cursor: "pointer",
    border: 0,
    padding: 0,
    appearance: "none",
...
const _UnstyledButton = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("UnstyledButton", {}, props), {
    ...
    component = "button",
    unstyled
  } = _a, others = __objRest$v(_a, ["className", "component", "unstyled"]);
  const {
    classes,
    cx
  } = useStyles$D(null, {
...
var useStyles$A = createStyles((theme, { color, size: size2, radius: radius2, variant: variant2, gradient: gradient2 }) => ({
  root: __spreadProps$j(__spreadValues$G({}, getVariantStyles$2({ variant: variant2, theme, color, gradient: gradient2 })), {
    position: "relative",
...
function Loader(props) {
  const _a = useComponentDefaultProps("Loader", defaultProps$j, props), {
    size: size2,
    color,
    variant: variant2
  } = _a, others = __objRest$r(_a, ["size", "color", "variant"]);
  const theme = useMantineTheme();
...
const _ActionIcon = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("ActionIcon", defaultProps$i, props), {
    className,
    color,
    children,
    radius: radius2,
    ...
    loading,
    unstyled
  } = _a, others = __objRest$q(_a, ["className", "color", "children", "radius", "size", "variant", "gradient", "disabled", "loaderProps", "loading", "unstyled"]);
  const {
    classes,
    cx,
    theme
...
function OptionalPortal(_a) {
  var _b = _a, {
    withinPortal = true,
    children
  } = _b, others = __objRest$p(_b, ["withinPortal", "children"]);
  if (withinPortal) {
    return /* @__PURE__ */ jsx(Portal, {
      ...__spreadValues$A({}, others),
      children
    });
  }
...
var useStyles$y = createStyles((theme, {
  ...
  return {
    root: __spreadValues$z(__spreadProps$i(__spreadValues$z(__spreadValues$z(__spreadValues$z({}, theme.fn.fontStyles()), theme.fn.focusStyles()), getLineClamp(lineClamp)), {
...
const _Text = react.exports.forwardRef((props, ref) => {
  const _a = useComponentDefaultProps("Text", defaultProps$h, props), {
    className,
    size: size2,
    weight,
    transform,
    ...
    unstyled,
    span
  } = _a, others = __objRest$o(_a, ["className", "size", "weight", "transform", "color", "align", "variant", "lineClamp", "gradient", "inline", "inherit", "underline", "strikethrough", "italic", "classNames", "styles", "unstyled", "span"]);
  const {
    classes,
    cx
  } = useStyles$z({
...
export {
  ...
  createRoot as H,
  BrowserRouter as I,
  useComponentDefaultProps as J,
  createPolymorphicComponent as K,
  LoadingOverlay as L,
