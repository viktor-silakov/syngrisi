...
function Check({
  ...
  const theme = useMantineTheme();
  useMutation((data) => ChecksService.removeCheck(data), {
    onSuccess: async (result) => {
      successMsg({
