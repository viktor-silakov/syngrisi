...
const {rect, PngImage, decode} = require("node-libpng");

const SHIFTING = {
    verticalShiftStablePixels: 3
}
...
async function compareWithTopShifting(baselineOrigin, actualOrigin, method, opts) {
    return new Promise(async function (resolve, reject) {
        try {
            ...
            for (let i = 1; i <= SHIFTING.verticalShiftStablePixels; i++) {
                ...
                const result = await makeDiff(image1, image2, opts);
...
function getDiff(baselineBufferPromise, actualBufferPromise, opts = {}) {
    return new Promise(async function (resolve, reject) {
        try {
             ...
             */
            diffs = [...diffs, ...(await compareWithTopShifting(baselineOrigin, actualOrigin, 'updown', opts))]
            diffs = [...diffs, ...(await compareWithTopShifting(baselineOrigin, actualOrigin, 'downup', opts))]
