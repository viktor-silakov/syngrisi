...
async function getDiff(baselineOrigin, actualOrigin, opts = {}) {
    ...
    try {
         ...
         */
        diffs = [...diffs, ...(await compareWithVerticalShiftingStabilization(baselineOrigin, actualOrigin, 'updown', opts))];
        diffs = [...diffs, ...(await compareWithVerticalShiftingStabilization(baselineOrigin, actualOrigin, 'downup', opts))];
